...
import { InquiryPriceTerminateInstancesResponse, AssociateInstancesKeyPairsResponse, ModifyChcAttributeResponse, DescribeHpcClustersRequest, DescribeImageQuotaResponse, ModifyInstancesProjectRequest, ConfigureChcDeployVpcResponse, InquiryPriceRenewHostsRequest, DeleteDisasterRecoverGroupsRequest, DeleteKeyPairsResponse, TerminateInstancesResponse, RepairTaskControlResponse, ModifyInstancesChargeTypeResponse, InquiryPriceResetInstancesInternetMaxBandwidthResponse, DescribeZonesRequest, ModifyKeyPairAttributeRequest, AssociateSecurityGroupsRequest, TerminateResourcePoolPacksRequest, ResetInstancesTypeRequest, DeleteLaunchTemplateVersionsRequest, DeleteImagesRequest, DeleteLaunchTemplateRequest, PurchaseResourcePoolPacksResponse, DescribeInstancesResponse, DescribeHostsResponse, DeleteKeyPairsRequest, ModifyInstancesDisasterRecoverGroupRequest, ModifyHpcClusterAttributeRequest, ExitRescueModeResponse, DescribeChcHostsResponse, RepairTaskControlRequest, AllocateHostsRequest, DescribeImageFromFamilyRequest, DescribeRegionsResponse, RebootInstancesRequest, ResetInstancesTypeResponse, DeleteInstancesActionTimerRequest, AssociateInstancesKeyPairsRequest, DeleteLaunchTemplateResponse, DescribeChcDeniedActionsResponse, DescribeInstancesStatusResponse, ModifyHpcClusterAttributeResponse, PurchaseResourcePoolPacksRequest, DescribeResourcePoolPackInstancesResponse, InquiryPriceModifyInstancesChargeTypeResponse, ImportInstancesActionTimerResponse, DescribeKeyPairsResponse, ResetInstancesPasswordRequest, ModifyChcNetworkModeResponse, DescribeInternetChargeTypeConfigsResponse, DescribeImagesResponse, ModifyInstancesVpcAttributeResponse, DescribeLaunchTemplatesResponse, DeleteHpcClustersResponse, DeleteInstancesDisasterRecoverGroupsRequest, DescribeInstancesActionTimerResponse, DescribeInstancesOperationLimitRequest, ResetInstancesPasswordResponse, ModifyImageAttributeRequest, EnterRescueModeRequest, DescribeInstanceVncUrlRequest, StopInstancesResponse, ModifyImageSharePermissionRequest, TerminateResourcePoolPacksResponse, DisassociateInstancesKeyPairsResponse, DescribeLaunchTemplateVersionsRequest, InquiryPriceResizeInstanceDisksRequest, RunInstancesResponse, DescribeHpcClustersResponse, ModifyImageSharePermissionResponse, DescribeInstancesOperationLimitResponse, SyncImagesResponse, ModifyChcAttributeRequest, DescribeZoneInstanceConfigInfosResponse, ModifyInstancesAttributeRequest, RenewHostsRequest, CreateDisasterRecoverGroupResponse, RemoveChcAssistVpcRequest, ConvertOperatingSystemsRequest, StartInstancesRequest, ProgramFpgaImageResponse, DescribeResourcePoolPackTypeConfigsRequest, DescribeInstanceInternetBandwidthConfigsResponse, DescribeResourcePoolPackTypeConfigsResponse, CreateHpcClusterResponse, DescribeDisasterRecoverGroupsRequest, SyncImagesRequest, DisassociateInstancesKeyPairsRequest, DescribeImageQuotaRequest, ResetInstancesInternetMaxBandwidthResponse, ConfigureChcDeployVpcRequest, DescribeInstanceFamilyConfigsResponse, ImportKeyPairResponse, InquirePricePurchaseResourcePoolPacksResponse, CreateImageResponse, DeleteInstancesActionTimerResponse, DescribeInstancesModificationRequest, DescribeImageSharePermissionResponse, DescribeInstancesAttributesResponse, DescribeTaskInfoRequest, InquiryPriceRunInstancesRequest, DescribeDisasterRecoverGroupQuotaResponse, DescribeRegionsRequest, ImportInstancesActionTimerRequest, CreateDisasterRecoverGroupRequest, DescribeChcDeniedActionsRequest, DescribeImportImageOsResponse, ModifyKeyPairAttributeResponse, StopInstancesRequest, DescribeKeyPairsRequest, DeleteDisasterRecoverGroupsResponse, ConvertOperatingSystemsResponse, InquiryPriceModifyInstancesChargeTypeRequest, CreateImageRequest, CreateLaunchTemplateVersionRequest, CreateKeyPairResponse, DescribeInstanceVncUrlResponse, DescribeInternetChargeTypeConfigsRequest, ExitRescueModeRequest, DescribeDisasterRecoverGroupsResponse, ExportImagesRequest, ModifyInstanceDiskTypeResponse, CreateLaunchTemplateRequest, InquiryPriceResetInstanceRequest, DescribeLaunchTemplatesRequest, ResetInstancesInternetMaxBandwidthRequest, RemoveChcDeployVpcResponse, AssociateSecurityGroupsResponse, ImportImageRequest, ConfigureChcAssistVpcRequest, DescribeImportImageOsRequest, CreateLaunchTemplateResponse, CreateKeyPairRequest, InquiryPriceRenewInstancesResponse, AllocateHostsResponse, DescribeImageSharePermissionRequest, DescribeInstancesAttributesRequest, DescribeInstanceTypeConfigsRequest, InquiryPriceResetInstanceResponse, RunInstancesRequest, DescribeResourcePoolPacksRequest, CreateHpcClusterRequest, InquiryPriceResetInstancesInternetMaxBandwidthRequest, ModifyHostsAttributeResponse, EnterRescueModeResponse, DescribeTaskInfoResponse, DescribeDisasterRecoverGroupQuotaRequest, DeleteLaunchTemplateVersionsResponse, StartInstancesResponse, ModifyInstancesVpcAttributeRequest, DeleteInstancesDisasterRecoverGroupsResponse, ModifyInstancesChargeTypeRequest, ResizeInstanceDisksRequest, DescribeZoneInstanceConfigInfosRequest, DescribeZonesResponse, InquiryPriceTerminateInstancesRequest, ExportImagesResponse, RemoveChcDeployVpcRequest, InquiryPriceRunInstancesResponse, DescribeHostsRequest, DescribeAccountQuotaRequest, InquirePricePurchaseResourcePoolPacksRequest, ModifyInstancesRenewFlagResponse, ModifyLaunchTemplateDefaultVersionResponse, DescribeInstancesStatusRequest, InquiryPriceResizeInstanceDisksResponse, TerminateInstancesRequest, ModifyChcNetworkModeRequest, DeleteImagesResponse, ResetInstanceRequest, ImportImageResponse, ModifyDisasterRecoverGroupAttributeRequest, ConfigureChcAssistVpcResponse, RebootInstancesResponse, DescribeChcHostsRequest, ModifyInstanceDiskTypeRequest, InquiryPriceResetInstancesTypeResponse, DeleteHpcClustersRequest, CreateLaunchTemplateVersionResponse, ModifyImageAttributeResponse, InquiryPriceRenewInstancesRequest, DescribeInstancesRequest, DescribeImageFromFamilyResponse, ModifyLaunchTemplateDefaultVersionRequest, ModifyInstancesAttributeResponse, DescribeImagesRequest, InquiryPriceRenewHostsResponse, ResizeInstanceDisksResponse, ModifyInstancesRenewFlagRequest, DisassociateSecurityGroupsRequest, ModifyHostsAttributeRequest, RenewInstancesRequest, DescribeResourcePoolPackInstancesRequest, ImportKeyPairRequest, DescribeInstancesModificationResponse, RenewInstancesResponse, DescribeLaunchTemplateVersionsResponse, DescribeAccountQuotaResponse, ResetInstanceResponse, ProgramFpgaImageRequest, ModifyInstancesDisasterRecoverGroupResponse, ModifyDisasterRecoverGroupAttributeResponse, DescribeInstanceTypeConfigsResponse, DescribeInstancesActionTimerRequest, DescribeResourcePoolPacksResponse, DescribeInstanceFamilyConfigsRequest, DescribeInstanceInternetBandwidthConfigsRequest, RenewHostsResponse, DisassociateSecurityGroupsResponse, RemoveChcAssistVpcResponse, ModifyInstancesProjectResponse, InquiryPriceResetInstancesTypeRequest } from "./cvm_models";
/**
 * cvm client
 * @class
 */
...
* 本接口为异步接口，创建请求发送成功后会返回DedicatedResourcePackIds，此时创建任务并未完成。
     */
    PurchaseResourcePoolPacks(req: PurchaseResourcePoolPacksRequest, cb?: (error: string, rep: PurchaseResourcePoolPacksResponse) => void): Promise<PurchaseResourcePoolPacksResponse>;
    /**
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
     ...
     */
    DescribeResourcePoolPackInstances(req: DescribeResourcePoolPackInstancesRequest, cb?: (error: string, rep: DescribeResourcePoolPackInstancesResponse) => void): Promise<DescribeResourcePoolPackInstancesResponse>;
    /**
...
- 切换业务网络：chc物理服务器如下参数值为以下值是判断切换成功：NetworkMode=BUSINESS，LatestOperation=SwitchChcBusinessNetwork, LatestOperationState=SUCCESS。
     */
    ModifyChcNetworkMode(req: ModifyChcNetworkModeRequest, cb?: (error: string, rep: ModifyChcNetworkModeResponse) => void): Promise<ModifyChcNetworkModeResponse>;
    /**
...
* 释放底层物理资源并删除资源池记录。
     */
    TerminateResourcePoolPacks(req: TerminateResourcePoolPacksRequest, cb?: (error: string, rep: TerminateResourcePoolPacksResponse) => void): Promise<TerminateResourcePoolPacksResponse>;
    /**
...
* 本接口为异步接口，启动实例请求发送成功后会返回一个RequestId，此时操作并未立即完成。实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表启动实例操作成功。
     ...
     */
    DescribeResourcePoolPacks(req: DescribeResourcePoolPacksRequest, cb?: (error: string, rep: DescribeResourcePoolPacksResponse) => void): Promise<DescribeResourcePoolPacksResponse>;
    /**
...
* 已分享的镜像无法修改属性。
     ...
     */
    DeleteInstancesDisasterRecoverGroups(req: DeleteInstancesDisasterRecoverGroupsRequest, cb?: (error: string, rep: DeleteInstancesDisasterRecoverGroupsResponse) => void): Promise<DeleteInstancesDisasterRecoverGroupsResponse>;
    /**
...
* 只支持查询包年包月`CDH`实例的续费价格。
     ...
     */
    InquirePricePurchaseResourcePoolPacks(req: InquirePricePurchaseResourcePoolPacksRequest, cb?: (error: string, rep: InquirePricePurchaseResourcePoolPacksResponse) => void): Promise<InquirePricePurchaseResourcePoolPacksResponse>;
    /**
...
* 新实例模板中未显式指定的参数值，使用指定版本号对应参数值覆盖。
     ...
     */
    DescribeResourcePoolPackTypeConfigs(req: DescribeResourcePoolPackTypeConfigsRequest, cb?: (error: string, rep: DescribeResourcePoolPackTypeConfigsResponse) => void): Promise<DescribeResourcePoolPackTypeConfigsResponse>;
    /**
