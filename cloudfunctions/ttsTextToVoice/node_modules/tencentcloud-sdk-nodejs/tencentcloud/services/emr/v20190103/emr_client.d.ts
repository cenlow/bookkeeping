...
import { AddNodeResourceConfigRequest, TerminateTasksRequest, DescribeEMREventListResponse, DescribeEmrApplicationStaticsRequest, DescribeTrinoQueryInfoResponse, ResetYarnConfigRequest, DescribeServiceNodeInfosResponse, AttachDisksRequest, AddUsersForUserManagerResponse, DeleteNodeResourceConfigRequest, TerminateTasksResponse, DescribeSparkQueriesResponse, InstallSoftwareRequest, DescribeInspectionTaskResultRequest, InquiryPriceCreateInstanceResponse, DescribeHDFSStorageInfoRequest, DescribeGlobalConfigResponse, ModifyResourceRequest, DescribeBootScriptResponse, DescribeHBaseTableRequestMetricRequest, RunJobFlowRequest, ScaleOutClusterRequest, DescribeHiveQueriesRequest, CreateClusterResponse, DescribeCvmQuotaResponse, AddMetricScaleStrategyResponse, DescribeNodeResourceConfigFastRequest, SyncPodStateRequest, DescribeSLInstanceListResponse, ModifyDynamicInstanceResponse, DescribeServiceConfGroupInfosRequest, InquiryPriceUpdateInstanceRequest, AttachDisksResponse, DescribeSparkQueriesRequest, DescribeInstancesResponse, DescribeUsersForUserManagerResponse, DescribeResourceScheduleDiffDetailRequest, InquirePriceRenewEmrResponse, DescribeSLInstanceRequest, ModifyAutoRenewFlagRequest, AddNodeResourceConfigResponse, ModifyResourceScheduleConfigRequest, DeleteAutoScaleStrategyResponse, DescribeStarRocksQueryInfoResponse, ModifyResourceSchedulerResponse, DescribeAutoScaleRecordsRequest, DescribeHBaseTableRequestMetricResponse, DescribeJobFlowResponse, DescribeEmrOverviewMetricsRequest, ModifyResourceResponse, ModifyUserGroupResponse, DescribeHDFSStorageInfoResponse, ModifyPodNumResponse, ModifyGlobalConfigResponse, CreateGroupsSTDResponse, ModifySLInstanceBasicRequest, CreateCloudInstanceResponse, ScaleOutInstanceRequest, ModifyAutoScaleStrategyRequest, DescribeGroupsSTDRequest, DescribeKyuubiQueryInfoResponse, DescribeBootScriptRequest, DescribeServiceConfGroupInfosResponse, DescribeInstanceOplogRequest, ModifyYarnDeployRequest, DescribeClusterFlowStatusDetailRequest, DescribeDAGInfoResponse, RunJobFlowResponse, DescribeHiveQueriesResponse, CreateDynamicInstanceRequest, DescribeInstanceRenewNodesResponse, CreateClusterRequest, CreateSLInstanceResponse, DescribeClusterNodesResponse, DescribeYarnApplicationsRequest, ModifyBootScriptResponse, DeleteUserManagerUserListRequest, DescribeResourceScheduleResponse, DescribeKyuubiQueryInfoRequest, DescribeNodeResourceConfigFastResponse, DescribeInsightListResponse, DescribeAutoScaleRecordsResponse, DescribeInspectionTaskResultResponse, DescribeCvmQuotaRequest, CreateInstanceRequest, InstallSoftwareResponse, ModifyUsersOfGroupSTDRequest, DeleteAutoScaleStrategyRequest, DescribeInstancesListResponse, ModifyResourcePoolsResponse, DescribeInstanceRenewNodesRequest, DescribeYarnApplicationsResponse, InquiryPriceCreateInstanceRequest, DescribeSLInstanceResponse, ModifySLInstanceResponse, ModifyGlobalConfigRequest, DescribeHBaseTableStoreSizeMetricResponse, DescribeImpalaQueriesResponse, SetNodeResourceConfigDefaultResponse, DescribeDynamicInstanceListRequest, ModifyInstanceBasicResponse, DescribeTrinoQueryInfoRequest, ModifyResourcePoolsRequest, TerminateInstanceResponse, DescribeSparkApplicationsResponse, ScaleOutInstanceResponse, ModifyUserManagerPwdResponse, TerminateDynamicInstancesRequest, CreateInstanceResponse, DescribeServiceNodeInfosRequest, DescribeHBaseTableStoreSizeMetricRequest, TerminateDynamicInstancesResponse, DescribeInstanceOplogResponse, DescribeAutoScaleGroupGlobalConfRequest, ModifyResourceScheduleConfigResponse, DescribeEMREventListRequest, DescribeDynamicInstanceListResponse, DescribeResourceScheduleDiffDetailResponse, DescribeYarnQueueResponse, CreateGroupsSTDRequest, ConvertPreToPostClusterRequest, DescribeNodeDataDisksRequest, DescribeJobFlowRequest, ModifyBootScriptRequest, ModifyYarnDeployResponse, DescribeUsersForUserManagerRequest, DescribeNodeSpecRequest, DescribeYarnScheduleHistoryRequest, StartStopServiceOrMonitorResponse, DescribeYarnQueueRequest, ModifyAutoRenewFlagResponse, DescribeYarnScheduleHistoryResponse, DescribeInsightListRequest, ModifyResourcesTagsRequest, TerminateClusterNodesResponse, DescribeSLInstanceListRequest, DeleteGroupsSTDResponse, DescribeImpalaQueriesRequest, ModifyPodNumRequest, ModifyUserGroupRequest, DescribeInstancesRequest, DeployYarnConfRequest, DescribeGroupsSTDResponse, DescribeNodeDataDisksResponse, DescribeInstancesListRequest, ModifyInstanceBasicRequest, AddUsersForUserManagerRequest, TerminateInstanceRequest, TerminateSLInstanceRequest, DescribeNodeSpecResponse, DescribeStarRocksQueryInfoRequest, ResizeDataDisksResponse, ModifySLInstanceBasicResponse, ResizeDataDisksRequest, ScaleOutClusterResponse, CreateSLInstanceRequest, DescribeGlobalConfigRequest, DescribeHBaseTableOverviewRequest, DescribeClusterFlowStatusDetailResponse, DescribeSparkApplicationsRequest, SyncPodStateResponse, ModifyDynamicInstanceRequest, ModifyUserManagerPwdRequest, ModifyInspectionSettingsResponse, DescribeHBaseTableOverviewResponse, AddMetricScaleStrategyRequest, ModifyUsersOfGroupSTDResponse, ResetYarnConfigResponse, InquiryPriceRenewInstanceResponse, StartStopServiceOrMonitorRequest, DescribeResourceScheduleRequest, DeleteNodeResourceConfigResponse, ConvertPreToPostClusterResponse, ModifyResourcesTagsResponse, SetNodeResourceConfigDefaultRequest, DescribeDAGInfoRequest, DescribeAutoScaleGroupGlobalConfResponse, InquiryPriceUpdateInstanceResponse, ModifyYarnQueueV2Response, ModifyInspectionSettingsRequest, ModifyResourceSchedulerRequest, ModifySLInstanceRequest, CreateCloudInstanceRequest, ModifyYarnQueueV2Request, DescribeClusterNodesRequest, DescribeEmrOverviewMetricsResponse, TerminateSLInstanceResponse, DescribeAutoScaleStrategiesRequest, DeployYarnConfResponse, DeleteUserManagerUserListResponse, InquiryPriceRenewInstanceRequest, DeleteGroupsSTDRequest, DescribeAutoScaleStrategiesResponse, CreateDynamicInstanceResponse, ModifyAutoScaleStrategyResponse, InquiryPriceScaleOutInstanceRequest, DescribeEmrApplicationStaticsResponse, InquirePriceRenewEmrRequest, InquiryPriceScaleOutInstanceResponse, TerminateClusterNodesRequest } from "./emr_models";
/**
 * emr client
 * @class
 */
export declare class Client extends AbstractClient {
     ...
     */
    CreateDynamicInstance(req: CreateDynamicInstanceRequest, cb?: (error: string, rep: CreateDynamicInstanceResponse) => void): Promise<CreateDynamicInstanceResponse>;
    /**
...
- 接口为异步接口，接口返回时操作并未立即完成，实例操作结果可以通过调用DescribeInstancesList查看当前实例的StatusDesc状态。
     ...
     */
    ModifyDynamicInstance(req: ModifyDynamicInstanceRequest, cb?: (error: string, rep: ModifyDynamicInstanceResponse) => void): Promise<ModifyDynamicInstanceResponse>;
    /**
     * 修改自动扩缩容规则
     */
     ...
     * 获取引导脚本
     */
    DescribeBootScript(req: DescribeBootScriptRequest, cb?: (error: string, rep: DescribeBootScriptResponse) => void): Promise<DescribeBootScriptResponse>;
    /**
     ...
     * 修改引导脚本
     */
    ModifyBootScript(req: ModifyBootScriptRequest, cb?: (error: string, rep: ModifyBootScriptResponse) => void): Promise<ModifyBootScriptResponse>;
    /**
     * 调整Pod数量
     */
...
- 接口为异步接口，接口返回时操作并未立即完成，实例操作结果可以通过调用DescribeInstancesList查看当前实例的StatusDesc状态。
     ...
     */
    DescribeHBaseTableStoreSizeMetric(req: DescribeHBaseTableStoreSizeMetricRequest, cb?: (error: string, rep: DescribeHBaseTableStoreSizeMetricResponse) => void): Promise<DescribeHBaseTableStoreSizeMetricResponse>;
    /**
     * 变配询价
     */
     ...
     * 获取实例操作日志
     */
    DescribeInstanceOplog(req: DescribeInstanceOplogRequest, cb?: (error: string, rep: DescribeInstanceOplogResponse) => void): Promise<DescribeInstanceOplogResponse>;
    /**
     * 创建EMR容器集群实例
     */
     ...
     * 查询EMR事件监控数据
     */
    DescribeEMREventList(req: DescribeEMREventListRequest, cb?: (error: string, rep: DescribeEMREventListResponse) => void): Promise<DescribeEMREventListResponse>;
    /**
     ...
     */
    DescribeDynamicInstanceList(req: DescribeDynamicInstanceListRequest, cb?: (error: string, rep: DescribeDynamicInstanceListResponse) => void): Promise<DescribeDynamicInstanceListResponse>;
    /**
     * 销毁集群节点
     */
     ...
     * Hbase的表粒度读取和写入速率
     */
    DescribeHBaseTableRequestMetric(req: DescribeHBaseTableRequestMetricRequest, cb?: (error: string, rep: DescribeHBaseTableRequestMetricResponse) => void): Promise<DescribeHBaseTableRequestMetricResponse>;
    /**
     ...
     */
    InstallSoftware(req: InstallSoftwareRequest, cb?: (error: string, rep: InstallSoftwareResponse) => void): Promise<InstallSoftwareResponse>;
    /**
     ...
     */
    TerminateDynamicInstances(req: TerminateDynamicInstancesRequest, cb?: (error: string, rep: TerminateDynamicInstancesResponse) => void): Promise<TerminateDynamicInstancesResponse>;
    /**
     * 获取巡检任务结果列表
     */
