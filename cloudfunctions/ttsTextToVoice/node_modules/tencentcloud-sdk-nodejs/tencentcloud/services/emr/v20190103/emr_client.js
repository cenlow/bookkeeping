...
- 接口为异步接口，接口返回时操作并未立即完成，实例操作结果可以通过调用DescribeInstancesList查看当前实例的StatusDesc状态。
     ...
     */
    async DescribeHBaseTableStoreSizeMetric(req, cb) {
     ...
     * 获取实例操作日志
     */
    async DescribeInstanceOplog(req, cb) {
     ...
     * 查询EMR事件监控数据
     */
    async DescribeEMREventList(req, cb) {
     ...
     * Hbase的表粒度读取和写入速率
     */
    async DescribeHBaseTableRequestMetric(req, cb) {
