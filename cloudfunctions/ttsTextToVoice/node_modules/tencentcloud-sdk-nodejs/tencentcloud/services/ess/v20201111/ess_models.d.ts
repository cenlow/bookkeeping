 ...
 */
export interface DescribeContractReviewChecklistRequest {
    /**
 ...
 */
export interface ImportContractReviewChecklistResponse {
    /**
     * <p>导入成功的合同审查清单ID</p>
     */
    ChecklistId?: string;
 ...
 */
export interface DescribeContractReviewChecklistResponse {
    /**
     * <p>获取的合同风险审查清单ID</p>
     */
    ChecklistId?: string;
 ...
 */
export interface ImportContractReviewChecklistRequest {
    /**
     * <p>执行本接口操作的员工信息。<br>注: <code>在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。</code></p>
     */
    Operator: UserInfo;
...
export interface ApproverInfo {
    ...
    ApproverName?: string;
    /**
     * <p>签署方经办人手机号码， 支持中国大陆手机号11位数字(无需加+86前缀或其他字符)。<br>请确认手机号所有方为此合同签署方。</p>
     */
    ApproverMobile?: string;
    /**
    ...
    ApproverRoleName?: string;
    /**
     * <p><font color="red">【已不再使用】</font>签署意愿确认渠道，默认为WEIXINAPP:人脸识别</p><p>注: 该字段已不再使用, 请用ApproverSignTypes签署人签署合同时的认证方式代替, 新客户可请用ApproverSignTypes来设置</p>
     */
    VerifyChannel?: Array<string>;
    /**
     * <p>签署方在签署合同之前，需要强制阅读合同的时长，可指定为3秒至300秒之间的任意值。</p><p>若未指定阅读时间，则会按照合同页数大小计算阅读时间，计算规则如下：</p><ul><li>合同页数少于等于2页，阅读时间为3秒；</li><li>合同页数为3到5页，阅读时间为5秒；</li><li>合同页数大于等于6页，阅读时间为10秒。</li></ul>
    ...
    CustomApproverTag?: string;
    /**
     * <p>可以控制签署方在签署合同时能否进行某些操作，例如拒签、转交他人等。<br>详细操作可以参考开发者中心的ApproverOption结构体。</p>
     */
    ApproverOption?: ApproverOption;
    /**
     * <p>【在用文件发起合同场景下才有效，模板发起场景下需要在模板中配置】指定个人签署方查看合同的校验方式,可以传值如下:</p><ul><li>  **1**   : （默认）人脸识别,人脸识别后才能合同内容</li><li>  **2**  : 手机号验证, 用户手机号和参与方手机号(ApproverMobile)相同即可查看合同内容（当手写签名方式为OCR_ESIGN时，该校验方式无效，因为这种签名方式依赖实名认证）</li></ul>注: <ul><li>如果合同流程设置ApproverVerifyType查看合同的校验方式,    则忽略此签署人的查看合同的校验方式</li><li>此字段可传多个校验方式</li></ul>
     */
    ApproverVerifyTypes?: Array<number | bigint>;
    /**
...
export interface CreateFlowRemindsRequest {
     ...
     */
    RemindTypes?: Array<string>;
    /**
     * <p>邮箱覆盖列表，为指定签署人使用特定邮箱发送邮件催办</p>
     */
    RemindEmailInfos?: Array<RemindEmailInfo>;
}
/**
