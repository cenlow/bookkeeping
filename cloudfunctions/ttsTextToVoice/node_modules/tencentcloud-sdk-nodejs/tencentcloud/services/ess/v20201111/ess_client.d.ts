...
适用场景：对比两份合同中字段（如：金额、日期、甲方名称等）的内容差异。
     ...
     */
    DescribeContractReviewChecklist(req: DescribeContractReviewChecklistRequest, cb?: (error: string, rep: DescribeContractReviewChecklistResponse) => void): Promise<DescribeContractReviewChecklistResponse>;
    /**
     * 获取个人用户自动签的开通链接。
...
注: <font color='red'>所在企业的超管、法人才有权限调用此接口</font>(Operator.UserId需要传递超管或者法人的UserId)
     ...
     */
    DescribeRiskIdentificationTaskFeedback(req: DescribeRiskIdentificationTaskFeedbackRequest, cb?: (error: string, rep: DescribeRiskIdentificationTaskFeedbackResponse) => void): Promise<DescribeRiskIdentificationTaskFeedbackResponse>;
    /**
     * 此接口（CreateDraftContractByPromptsTask）用于创建智能合同起草任务。
     */
    CreateDraftContractByPromptsTask(req: CreateDraftContractByPromptsTaskRequest, cb?: (error: string, rep: CreateDraftContractByPromptsTaskResponse) => void): Promise<CreateDraftContractByPromptsTaskResponse>;
    /**
     * 通过此接口获取个人用户自动签的开通状态。
...
### 4.合同组暂不支持抄送功能
     ...
     */
    ImportContractReviewChecklist(req: ImportContractReviewChecklistRequest, cb?: (error: string, rep: ImportContractReviewChecklistResponse) => void): Promise<ImportContractReviewChecklistResponse>;
    /**
...
注意:  `如果文件资源为word类型生成的链接不能进行iframe嵌入，需要在单独窗口打开`
     */
    DescribeContractReviewChecklistsWebUrl(req: DescribeContractReviewChecklistsWebUrlRequest, cb?: (error: string, rep: DescribeContractReviewChecklistsWebUrlResponse) => void): Promise<DescribeContractReviewChecklistsWebUrlResponse>;
    /**
     ...
     */
    ExportContractReviewMarkedRisk(req: ExportContractReviewMarkedRiskRequest, cb?: (error: string, rep: ExportContractReviewMarkedRiskResponse) => void): Promise<ExportContractReviewMarkedRiskResponse>;
    /**
     * 获取个人用户认证证书图片下载URL
...
注意:  `如果文件资源为word类型生成的链接不能进行iframe嵌入，需要在单独窗口打开`
     */
    DescribeContractReviewWebUrl(req: DescribeContractReviewWebUrlRequest, cb?: (error: string, rep: DescribeContractReviewWebUrlResponse) => void): Promise<DescribeContractReviewWebUrlResponse>;
    /**
...
2. 仅支持5份PDF文件批量发起（一份PDF对应一个审查任务）
     ...
     * 数据加签验签接口
     */
    VerifyDigitalDataSign(req: VerifyDigitalDataSignRequest, cb?: (error: string, rep: VerifyDigitalDataSignResponse) => void): Promise<VerifyDigitalDataSignResponse>;
    /**
     * 获取设置自动签印章小程序链接。
...
![image](https://qcloudimg.tencent-cloud.cn/raw/8cb6c8707a3b8c86b55e47fd8d23b30a/a3333.png)
     ...
     */
    DescribeContractReviewTask(req: DescribeContractReviewTaskRequest, cb?: (error: string, rep: DescribeContractReviewTaskResponse) => void): Promise<DescribeContractReviewTaskResponse>;
    /**
     * 已经不再使用
...
注: 需自行保证传入真实的企业/法人/超管信息，否则后续的审核将会拒绝。
     */
    CreateOrganizationAuthFile(req: CreateOrganizationAuthFileRequest, cb?: (error: string, rep: CreateOrganizationAuthFileResponse) => void): Promise<CreateOrganizationAuthFileResponse>;
    /**
     ...
     */
    ExportContractReviewResult(req: ExportContractReviewResultRequest, cb?: (error: string, rep: ExportContractReviewResultResponse) => void): Promise<ExportContractReviewResultResponse>;
    /**
...
<li>处方单等特殊场景专用，此接口为白名单功能，使用前请联系对接的客户经理沟通。</li></ul>
     ...
     */
    DescribeContractReviewMarkedRiskExportTask(req: DescribeContractReviewMarkedRiskExportTaskRequest, cb?: (error: string, rep: DescribeContractReviewMarkedRiskExportTaskResponse) => void): Promise<DescribeContractReviewMarkedRiskExportTaskResponse>;
    /**
...
该接口支持员工和个人端手机号的变更。
     ...
     */
    DescribeLMInformationExtractionTaskFieldFeedback(req: DescribeLMInformationExtractionTaskFieldFeedbackRequest, cb?: (error: string, rep: DescribeLMInformationExtractionTaskFieldFeedbackResponse) => void): Promise<DescribeLMInformationExtractionTaskFieldFeedbackResponse>;
    /**
...
| 腾讯电子签Demo | wx371151823f6f3edf | gh_39a5d3de69fa |
     ...
     */
    DescribeInformationExtractionWebUrl(req: DescribeInformationExtractionWebUrlRequest, cb?: (error: string, rep: DescribeInformationExtractionWebUrlResponse) => void): Promise<DescribeInformationExtractionWebUrlResponse>;
    /**
     * 检测个人用户是否已经实名。
...
2. pdg、jpeg、jpg格式限制大小为5M以下
     */
    CreateInformationExtractionWebUrl(req: CreateInformationExtractionWebUrlRequest, cb?: (error: string, rep: CreateInformationExtractionWebUrlResponse) => void): Promise<CreateInformationExtractionWebUrlResponse>;
    /**
...
| 腾讯电子签Demo | wx371151823f6f3edf | gh_39a5d3de69fa |
     */
    CreateMiniAppPrepareFlow(req: CreateMiniAppPrepareFlowRequest, cb?: (error: string, rep: CreateMiniAppPrepareFlowResponse) => void): Promise<CreateMiniAppPrepareFlowResponse>;
    /**
...
4. <font color='red'>需要授权企业或被授权企业的超管或者法人打开链接</font>走开通逻辑。
     ...
     */
    CreateLMInformationExtractionTaskFieldFeedback(req: CreateLMInformationExtractionTaskFieldFeedbackRequest, cb?: (error: string, rep: CreateLMInformationExtractionTaskFieldFeedbackResponse) => void): Promise<CreateLMInformationExtractionTaskFieldFeedbackResponse>;
    /**
...
<li>QueryBindTemplate:false，查询用户合同模板类型，返回用户合同模板类型ID，用户合同模板类型名称，用户合同模板类型描述信息，被绑定的模板数量</li>
     ...
     */
    DescribeDraftContractByPromptsTask(req: DescribeDraftContractByPromptsTaskRequest, cb?: (error: string, rep: DescribeDraftContractByPromptsTaskResponse) => void): Promise<DescribeDraftContractByPromptsTaskResponse>;
    /**
...
注意:  `如果文件资源为word类型生成的链接不能进行iframe嵌入，需要在单独窗口打开`
     */
    CreateContractReviewChecklistWebUrl(req: CreateContractReviewChecklistWebUrlRequest, cb?: (error: string, rep: CreateContractReviewChecklistWebUrlResponse) => void): Promise<CreateContractReviewChecklistWebUrlResponse>;
    /**
...
**这个接口的操作人必须跟生成批量认证链接接口的操作人一致，才可以调用，否则会返回当前操作人没有认证中的企业认证流**
     */
    DeleteOrganizationAuthorizations(req: DeleteOrganizationAuthorizationsRequest, cb?: (error: string, rep: DeleteOrganizationAuthorizationsResponse) => void): Promise<DeleteOrganizationAuthorizationsResponse>;
    /**
     * 此接口（CreateRiskIdentificationTaskFeedback）用于创建合同审查任务结果反馈。
     */
    CreateRiskIdentificationTaskFeedback(req: CreateRiskIdentificationTaskFeedbackRequest, cb?: (error: string, rep: CreateRiskIdentificationTaskFeedbackResponse) => void): Promise<CreateRiskIdentificationTaskFeedbackResponse>;
    /**
...
3. 当前仅支持修改回调地址和加密key。
     */
    ModifyPartnerAuthorization(req: ModifyPartnerAuthorizationRequest, cb?: (error: string, rep: ModifyPartnerAuthorizationResponse) => void): Promise<ModifyPartnerAuthorizationResponse>;
    /**
     * 用于撤销合同流程<br/>
...
注意:  `如果文件资源为word类型生成的链接不能进行iframe嵌入，需要在单独窗口打开`
     */
    DescribeContractReviewChecklistWebUrl(req: DescribeContractReviewChecklistWebUrlRequest, cb?: (error: string, rep: DescribeContractReviewChecklistWebUrlResponse) => void): Promise<DescribeContractReviewChecklistWebUrlResponse>;
    /**
...
5. 创建好的第三方应用号，不支持在页面进行修改编辑，只能通过接口的方式进行管理。
     */
    CreatePartnerAuthorizationLink(req: CreatePartnerAuthorizationLinkRequest, cb?: (error: string, rep: CreatePartnerAuthorizationLinkResponse) => void): Promise<CreatePartnerAuthorizationLinkResponse>;
    /**
...
- 返回的FlowGroupId 为临时id，只有在页面内成功发起后FlowGroupId才会有效。
     ...
     */
    DescribeEnterpriseContractReviewChecklists(req: DescribeEnterpriseContractReviewChecklistsRequest, cb?: (error: string, rep: DescribeEnterpriseContractReviewChecklistsResponse) => void): Promise<DescribeEnterpriseContractReviewChecklistsResponse>;
    /**
...
2. 如果文件资源为word类型生成的链接不能进行iframe嵌入，需要在单独窗口打开
     */
    CreateContractReviewWebUrl(req: CreateContractReviewWebUrlRequest, cb?: (error: string, rep: CreateContractReviewWebUrlResponse) => void): Promise<CreateContractReviewWebUrlResponse>;
    /**
...
1. 此操作要求操作者具备<b>印章查询权限</b>（若调用者尚无此权限，请联系超级管理员前往Web控制台【组织管理】->【角色管理】添加相应权限）。
     ...
     * 创建数据加签请求
     */
    CreateDigitalDataSign(req: CreateDigitalDataSignRequest, cb?: (error: string, rep: CreateDigitalDataSignResponse) => void): Promise<CreateDigitalDataSignResponse>;
    /**
     * 获取跳转至腾讯电子签小程序的签署链接
