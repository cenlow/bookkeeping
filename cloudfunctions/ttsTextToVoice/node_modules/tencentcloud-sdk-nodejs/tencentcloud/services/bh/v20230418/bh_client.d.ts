...
export declare class Client extends AbstractClient {
     ...
     * 绑定容器账号凭据
     */
    BindDeviceAccountKubeconfig(req: BindDeviceAccountKubeconfigRequest, cb?: (error: string, rep: BindDeviceAccountKubeconfigResponse) => void): Promise<BindDeviceAccountKubeconfigResponse>;
    /**
     * 更新修改密码任务
     */
