...
import { SetAutoRenewFlagRequest, DeleteBackupPlanResponse, DescribeAccountPrivilegesResponse, DescribeDatabasesRequest, DescribeDBXlogsRequest, DescribeAuditLogsRequest, DescribeMaintainTimeWindowRequest, DescribeAccountsRequest, DeleteReadOnlyGroupResponse, OpenDBExtranetAccessRequest, CreateInstancesRequest, ModifyDBInstanceSSLConfigRequest, CreateDBInstanceNetworkAccessResponse, DescribeAvailableRecoveryTimeResponse, CreateBaseBackupRequest, ModifyDBInstanceReadOnlyGroupResponse, DescribeDBInstanceParametersResponse, DescribeDBInstanceSecurityGroupsResponse, RestoreDBInstanceObjectsResponse, ModifyDBInstanceDeletionProtectionRequest, RenewInstanceResponse, DeleteLogBackupResponse, ModifyReadOnlyGroupConfigRequest, AddDBInstanceToReadOnlyGroupRequest, DescribeProductConfigRequest, RemoveDBInstanceFromReadOnlyGroupRequest, CreateAccountRequest, DescribeTasksResponse, DescribeMaintainTimeWindowResponse, DescribeDedicatedClustersResponse, RenewInstanceRequest, DescribeBackupOverviewRequest, DescribeRegionsResponse, DescribeAuditInstanceListResponse, ModifyBackupDownloadRestrictionRequest, ModifyDBInstanceDeploymentRequest, DeleteReadOnlyGroupNetworkAccessRequest, DescribeBackupPlansRequest, CreateDatabaseRequest, DescribeBackupSummariesRequest, CreateBackupPlanRequest, ModifyDBInstancesProjectResponse, CreateBaseBackupResponse, LockAccountResponse, CloneDBInstanceResponse, ModifyDBInstanceReadOnlyGroupRequest, AddDBInstanceToReadOnlyGroupResponse, CreateReadOnlyDBInstanceResponse, DescribeAvailableRecoveryTimeRequest, CloseAccountCAMRequest, DescribeTasksRequest, DescribeDBInstanceParametersRequest, DescribeOrdersResponse, DescribeBackupDownloadURLResponse, ModifyBaseBackupExpireTimeResponse, ModifyMaintainTimeWindowResponse, InquiryPriceCreateDBInstancesResponse, DeleteAuditLogFileResponse, CreateDBInstanceNetworkAccessRequest, ModifySwitchTimePeriodResponse, InquiryPriceCreateDBInstancesRequest, DescribeDefaultParametersResponse, DescribeBackupPlansResponse, DescribeDBInstancesRequest, ModifyDBInstanceSpecRequest, ModifyAccountRemarkResponse, RefreshAccountPasswordRequest, OpenAccountCAMResponse, DescribeZonesRequest, ModifyMaintainTimeWindowRequest, ModifyBackupDownloadRestrictionResponse, DescribeLogBackupsRequest, ModifyDBInstanceParametersRequest, CreateAuditLogFileResponse, DescribeDBInstanceAttributeRequest, ResetAccountPasswordResponse, RemoveDBInstanceFromReadOnlyGroupResponse, DescribeDatabaseObjectsRequest, DescribeParameterTemplatesResponse, UpgradeDBInstanceKernelVersionRequest, OpenAuditServiceRequest, SwitchDBInstancePrimaryResponse, ModifyReadOnlyDBInstanceWeightResponse, ModifyDBInstanceHAConfigRequest, DescribeAuditLogFilesResponse, DeleteReadOnlyGroupNetworkAccessResponse, DescribeBackupSummariesResponse, DescribeDBErrlogsRequest, DeleteBackupPlanRequest, CloneDBInstanceRequest, DeleteParameterTemplateRequest, DescribeClassesRequest, DescribeParamsEventRequest, CreateInstancesResponse, DescribeDBBackupsResponse, DescribeRegionsRequest, DescribeSlowQueryListResponse, CreateReadOnlyGroupRequest, ModifyDBInstanceSSLConfigResponse, DescribeParamsEventResponse, CloseAuditServiceResponse, ModifyDBInstanceSecurityGroupsRequest, CloseAuditServiceRequest, DescribeDedicatedClustersRequest, CreateReadOnlyGroupNetworkAccessRequest, RestartDBInstanceRequest, DescribeDBInstanceHAConfigRequest, CreateParameterTemplateResponse, DescribeLogBackupsResponse, IsolateDBInstancesResponse, OpenDBExtranetAccessResponse, InquiryPriceUpgradeDBInstanceRequest, DescribeDBInstanceHAConfigResponse, DescribeDatabaseObjectsResponse, IsolateDBInstancesRequest, ModifyDBInstanceNameRequest, DescribeDBInstanceSSLConfigResponse, CloseAccountCAMResponse, SwitchDBInstancePrimaryRequest, InquiryPriceRenewDBInstanceResponse, DescribeSlowQueryAnalysisRequest, DestroyDBInstanceRequest, InquiryPriceRenewDBInstanceRequest, DescribeBackupOverviewResponse, DescribeParameterTemplatesRequest, OpenAccountCAMRequest, DescribeClassesResponse, DeleteDBInstanceNetworkAccessRequest, ModifyDBInstanceDeploymentResponse, UnlockAccountRequest, DeleteParameterTemplateResponse, ModifyReadOnlyDBInstanceWeightRequest, DescribeAuditInstanceListRequest, ModifyAccountPrivilegesResponse, DeleteReadOnlyGroupRequest, DescribeDBBackupsRequest, SetAutoRenewFlagResponse, RestartDBInstanceResponse, UpgradeDBInstanceMajorVersionResponse, DescribeBackupDownloadURLRequest, ModifyParameterTemplateRequest, DescribeDBVersionsResponse, ModifyAuditServiceRequest, UnlockAccountResponse, ModifyDBInstanceSecurityGroupsResponse, ModifyDBInstanceNameResponse, UpgradeDBInstanceMajorVersionRequest, CloseDBExtranetAccessResponse, DescribeBackupDownloadRestrictionResponse, CreateReadOnlyDBInstanceRequest, DescribeCloneDBInstanceSpecResponse, DescribeZonesResponse, DescribeDatabasesResponse, DescribeProductConfigResponse, DescribeOrdersRequest, OpenAuditServiceResponse, CloseDBExtranetAccessRequest, ModifyParameterTemplateResponse, DescribeEncryptionKeysRequest, RebalanceReadOnlyGroupRequest, ModifyBackupPlanResponse, DeleteAccountRequest, CreateReadOnlyGroupResponse, DeleteDBInstanceNetworkAccessResponse, ModifyAccountPrivilegesRequest, ModifyDBInstanceParametersResponse, ModifyReadOnlyGroupConfigResponse, ModifyAccountRemarkRequest, DescribeParameterTemplateAttributesRequest, DescribeDBErrlogsResponse, ModifyBackupPlanRequest, DeleteBaseBackupRequest, InquiryPriceUpgradeDBInstanceResponse, DisIsolateDBInstancesResponse, ModifyDatabaseOwnerResponse, CreateParameterTemplateRequest, DescribeDBInstanceSSLConfigRequest, CreateAuditLogFileRequest, DeleteAuditLogFileRequest, ModifySwitchTimePeriodRequest, CreateAccountResponse, DescribeSlowQueryListRequest, DescribeCloneDBInstanceSpecRequest, ModifyDatabaseOwnerRequest, DisIsolateDBInstancesRequest, CreateBackupPlanResponse, LockAccountRequest, DescribeDBInstancesResponse, DescribeDBInstanceSecurityGroupsRequest, DescribeBackupDownloadRestrictionRequest, ModifyBaseBackupExpireTimeRequest, ModifyDBInstanceHAConfigResponse, CreateDatabaseResponse, RebalanceReadOnlyGroupResponse, ResetAccountPasswordRequest, DescribeSlowQueryAnalysisResponse, ModifyDBInstanceDeletionProtectionResponse, DescribeDefaultParametersRequest, DescribeReadOnlyGroupsRequest, DescribeAccountPrivilegesRequest, DescribeReadOnlyGroupsResponse, RestoreDBInstanceObjectsRequest, DescribeAccountsResponse, ModifyDBInstanceChargeTypeRequest, DescribeParameterTemplateAttributesResponse, UpgradeDBInstanceKernelVersionResponse, DescribeDBVersionsRequest, ModifyDBInstancesProjectRequest, ModifyAuditServiceResponse, DestroyDBInstanceResponse, DescribeDBInstanceAttributeResponse, DeleteLogBackupRequest, DeleteBaseBackupResponse, DescribeAuditLogFilesRequest, ModifyDBInstanceSpecResponse, RefreshAccountPasswordResponse, DescribeBaseBackupsResponse, DescribeDBXlogsResponse, ModifyDBInstanceChargeTypeResponse, DescribeBaseBackupsRequest, DescribeEncryptionKeysResponse, CreateReadOnlyGroupNetworkAccessResponse, DeleteAccountResponse, DescribeAuditLogsResponse } from "./postgres_models";
/**
 * postgres client
 * @class
 */
export declare class Client extends AbstractClient {
     ...
     */
    OpenAccountCAM(req: OpenAccountCAMRequest, cb?: (error: string, rep: OpenAccountCAMResponse) => void): Promise<OpenAccountCAMResponse>;
    /**
...
注：本接口中展示的步骤为总结性步骤，可能伴随着版本迭代进行调整，不建议作为关键逻辑使用
     ...
     */
    CloseAccountCAM(req: CloseAccountCAMRequest, cb?: (error: string, rep: CloseAccountCAMResponse) => void): Promise<CloseAccountCAMResponse>;
    /**
     ...
     */
    RefreshAccountPassword(req: RefreshAccountPasswordRequest, cb?: (error: string, rep: RefreshAccountPasswordResponse) => void): Promise<RefreshAccountPasswordResponse>;
    /**
     ...
     */
    ModifyDBInstanceDeletionProtection(req: ModifyDBInstanceDeletionProtectionRequest, cb?: (error: string, rep: ModifyDBInstanceDeletionProtectionResponse) => void): Promise<ModifyDBInstanceDeletionProtectionResponse>;
    /**
