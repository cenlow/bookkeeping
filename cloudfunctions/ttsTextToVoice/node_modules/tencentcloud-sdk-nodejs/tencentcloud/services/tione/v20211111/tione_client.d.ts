...
https://cloud.tencent.com/document/product/1278/85305
     ...
     */
    DescribeAnnotatedTaskList(req: DescribeAnnotatedTaskListRequest, cb?: (error: string, rep: DescribeAnnotatedTaskListResponse) => void): Promise<DescribeAnnotatedTaskListResponse>;
    /**
     * 非数据源挂载时获取实例列表
     */
