 ...
 */
export interface CreateAigcVideoRedrawTaskRequest {
    /**
 ...
 */
export interface CreateAigcVideoRedrawTaskResponse {
    /**
     * <p>任务 ID。</p>
     */
    TaskId?: string;
 ...
 */
export interface CreateAigcAdvancedCustomElementRequest {
    /**
     * <p><b>点播<a href="https://cloud.tencent.com/document/product/266/14574">应用</a> ID。从2023年12月25日起开通点播的客户，如访问点播应用中的资源（无论是默认应用还是新创建的应用），必须将该字段填写为应用 ID。</b></p>
     */
    SubAppId?: number;
 ...
 * 人脸识别的媒体信息
 */
export interface FaceRecognitionInfo {
    /**
     * <p>人脸识别任务列表</p>
     */
    FaceRecognitionTasks?: Array<FaceRecognitionTask>;
}
/**
 * 画质重生目标参数
 */
 ...
 * AIGC场景化生图任务输入文件信息
 */
export interface SceneAigcVideoTaskInputFileInfo {
    /**
 ...
 */
export interface CreateAigcSubjectResponse {
    /**
     * <p>任务ID。</p>
     */
    TaskId?: string;
 ...
 * 人脸身份信息。
 */
export interface AigcFaceIdentityInfo {
    /**
 ...
 */
export interface CreateAigcAdvancedCustomElementResponse {
    /**
     * <p>任务 ID。</p>
     */
    TaskId?: string;
 ...
 */
export interface CreateAigcCustomElementResponse {
    /**
     * 主体ID。需自行记录下返回的主体ID。
     */
    ElementId?: string;
...
export interface ProcessMediaByMPS {
     ...
     * MPS 视频处理任务。
     */
    SubTaskSet?: Array<MPSSubTaskResult>;
}
/**
 * 编辑视频任务的输入。
 */
 ...
 */
export interface SceneAigcImageTaskOutputFileInfo {
    /**
     * 存储模式。取值有： <li>Permanent：永久存储；</li> <li>Temporary：临时存储；</li>
 ...
 * 创建主体任务信息。
 */
export interface CreateAigcSubjectTask {
    /**
     * <p>任务ID。</p>
     */
    TaskId?: string;
 ...
 * 主体参考信息。
 */
export interface ElementReferInfo {
    /**
     * 不同角度的主体参考图片URL。
  图片格式支持.jpg / .jpeg / .png
 ...
 */
export interface CreateAigcCustomElementRequest {
    /**
     * 主体名称。不能超过20个字符
     */
    ElementName: string;
  ...
  图片文件大小不能超过10MB，图片宽高尺寸不小于300px，图片宽高比要在1:2.5 ~ 2.5:1之间。
     ...
     */
    ElementReferList: Array<ElementReferInfo>;
}
/**
 * 视频拆条任务信息。
 */
...
export interface SceneAigcVideoTaskInput {
     ...
     * 输入图片列表。
     */
    FileInfos?: Array<SceneAigcVideoTaskInputFileInfo>;
    /**
     * 场景化生图任务的输出媒体文件配置。
     */
 ...
 * 媒资智能知识库信息
 */
export interface KnowledgeBasesInfo {
    /**
     * <p>当前媒资当导入的知识库列表</p>
     */
    Bases?: Array<string>;
 ...
 * 场景化 AIGC 生成视频任务的输出。
 */
export interface SceneAigcVideoTaskOutput {
    /**
     * AIGC 生视频任务的输出文件信息。
     */
 ...
 * 场景化 AIGC 生视频任务信息
 */
export interface SceneAigcVideoTask {
    /**
     * 任务 ID。
     */
    TaskId?: string;
 ...
 * AIGC 视频转绘任务的输出文件信息。
 */
export interface AigcVideoRedrawOutputFileInfo {
    /**
 ...
 * 场景化 AIGC 生图任务信息
 */
export interface SceneAigcImageTask {
    /**
     * 任务 ID。
     */
    TaskId?: string;
 ...
 * 创建主体输出信息。
 */
export interface CreateAigcSubjectOutput {
    /**
     * <p>主体ID。</p>
     */
    SubjectId?: string;
 ...
 */
export interface CreateAigcSubjectRequest {
    /**
     * <p><b>点播<a href="https://cloud.tencent.com/document/product/266/14574">应用</a> ID。从2023年12月25日起开通点播的客户，如访问点播应用中的资源（无论是默认应用还是新创建的应用），必须将该字段填写为应用 ID。</b></p>
     */
    SubAppId?: number;
 ...
 * 人脸识别输出文件信息
 */
export interface FaceRecognitionOutputFileInfo {
    /**
 ...
 * 提取盲水印输入信息
 */
export interface ExtractBlindWatermarkInputInfo {
    /**
 ...
 * AIGC 视频转绘任务的输入。
 */
export interface AigcVideoRedrawTaskInput {
    /**
 ...
 * AIGC 主体输入信息。
 */
export interface AigcVideoTaskInputSubjectInfo {
    /**
...
export interface TranscodeTaskInput {
     ...
     */
    SubtitleInfoSet?: Array<SubtitleInfoInput>;
}
/**
...
export interface AigcFaceInfo {
     ...
     * 人脸信息列表。
     */
    FaceInfoList?: Array<AigcFaceIdentityInfo>;
}
/**
 ...
 */
export interface DescribeAigcFaceInfoResponse {
    /**
     * 人脸信息。
     */
 ...
 */
export interface CreateAigcApiTokenRequest {
    /**
     * <b>点播[应用](/document/product/266/14574) ID。从2023年12月25日起开通点播的客户，如访问点播应用中的资源（无论是默认应用还是新创建的应用），必须将该字段填写为应用 ID。</b>
     */
    SubAppId: number;
 ...
 */
export interface CreateAigcCustomVoiceResponse {
    /**
     * <p>任务 ID。</p>
     */
    TaskId?: string;
 ...
 */
export interface CreateSceneAigcVideoTaskResponse {
    /**
     * 任务 ID。
     */
    TaskId?: string;
 ...
 * 人脸识别任务
 */
export interface FaceRecognitionTask {
    /**
     * <p>人脸识别模板编号</p>
     */
    Definition?: number;
     ...
     * <p>输出文件信息</p>
     */
    OutputFile?: Array<FaceRecognitionOutputFileInfo>;
}
/**
 ...
 */
export interface DeleteAigcApiTokenRequest {
    /**
     * <b>点播[应用](/document/product/266/14574) ID。从2023年12月25日起开通点播的客户，如访问点播应用中的资源（无论是默认应用还是新创建的应用），必须将该字段填写为应用 ID。</b>
     */
    SubAppId: number;
 ...
 * AIGC 视频转绘任务的输出信息。
 */
export interface AigcVideoRedrawTaskOutput {
    /**
 ...
 */
export interface CreateAigcApiTokenResponse {
    /**
     * API的Token
     */
    ApiToken?: string;
 ...
 * AIGC 视频转绘任务输入文件信息。
 */
export interface AigcVideoRedrawTaskInputFileInfo {
    /**
     * <p>输入的视频文件类型。取值有： <li>File：点播媒体文件；</li> <li>Url：可访问的 Url；</li></p>
     */
    Type?: string;
 ...
 * 创建主体输入信息。
 */
export interface CreateAigcSubjectInput {
    /**
     * <p>主体名称。</p>
     */
    SubjectName?: string;
 ...
 * AIGC 视频转绘任务信息
 */
export interface AigcVideoRedrawTask {
    /**
     * <p>任务 ID。</p>
     */
    TaskId?: string;
    ...
    Progress?: number;
    /**
     * <p>AIGC 视频转绘任务的输入信息。</p>
     */
    Input?: AigcVideoRedrawTaskInput;
    /**
     * <p>AIGC 视频转绘任务的输出信息。</p>
     */
 ...
 */
export interface CreateAigcCustomVoiceRequest {
    /**
     * <p><b>点播<a href="https://cloud.tencent.com/document/product/266/14574">应用</a> ID。从2023年12月25日起开通点播的客户，如访问点播应用中的资源（无论是默认应用还是新创建的应用），必须将该字段填写为应用 ID。</b></p>
     */
    SubAppId?: number;
 ...
 * 场景化 AIGC 生图任务信息
 */
export interface SceneAigcImageTaskInput {
    /**
     * 场景化生图参数配置。
     */
    SceneInfo?: AigcImageSceneInfo;
 ...
 * 场景化 AIGC 生图配置。
 */
export interface AigcVideoSceneInfo {
    /**
     * AI生视频场景类型，可选值：
 ...
 */
export interface CreateSceneAigcVideoTaskRequest {
    /**
     * **点播应用 ID。从2023年12月25日起开通点播的客户，如访问点播应用中的资源（无论是默认应用还是新创建的应用），必须将该字段填写为应用 ID。**
     */
    SubAppId: number;
 ...
 * 字幕压制输入信息
 */
export interface SubtitleInfoInput {
    /**
     * <p>字幕 ID。</p>
     */
    Id: string;
