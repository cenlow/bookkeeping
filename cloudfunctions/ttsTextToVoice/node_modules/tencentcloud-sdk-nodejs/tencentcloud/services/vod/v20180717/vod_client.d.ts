...
import { ModifySampleSnapshotTemplateResponse, CreateAigcVideoRedrawTaskRequest, ModifyWatermarkTemplateRequest, CreateStorageRegionRequest, ExtractBlindWatermarkRequest, DescribeAllClassRequest, CreateAigcVideoRedrawTaskResponse, DescribeRoundPlaysRequest, WeChatMiniProgramPublishRequest, CreateTranscodeTemplateRequest, DescribeAnimatedGraphicsTemplatesRequest, LiveRealTimeClipResponse, DeleteJustInTimeTranscodeTemplateRequest, DeleteAnimatedGraphicsTemplateResponse, DescribeAigcFaceInfoRequest, ManageTaskResponse, CreateImageProcessingTemplateRequest, ModifyDefaultStorageRegionRequest, ModifyEventConfigResponse, DeleteLLMComprehendTemplateRequest, CreateAigcAdvancedCustomElementRequest, ModifySampleSnapshotTemplateRequest, ModifyJustInTimeTranscodeTemplateRequest, DescribePrepaidProductsRequest, ManageTaskRequest, DescribeImageReviewUsageDataResponse, RebuildMediaRequest, DescribeDefaultDistributionConfigRequest, CreateImageSpriteTemplateRequest, DeleteProcessImageAsyncTemplateResponse, RefreshUrlCacheRequest, DeleteAIRecognitionTemplateResponse, DeleteContentReviewTemplateRequest, CreateAigcSubjectResponse, VerifyDomainRecordResponse, DescribeCurrentPlaylistResponse, ModifySuperPlayerConfigRequest, ResetProcedureTemplateRequest, ComposeMediaResponse, DescribeLicenseUsageDataResponse, DeleteMPSTemplateRequest, ModifyWordSampleResponse, DescribeDailyMediaPlayStatResponse, ModifySubAppIdInfoRequest, DeletePersonSampleRequest, CreateAigcAdvancedCustomElementResponse, ExecuteFunctionResponse, DescribeClientUploadAccelerationUsageDataResponse, ModifyRebuildMediaTemplateRequest, ComposeMediaRequest, DescribeCLSTopicsRequest, CreateAigcCustomElementResponse, CreateAdaptiveDynamicStreamingTemplateRequest, PushUrlCacheResponse, DescribeDailyMediaPlayStatRequest, ModifyTranscodeTemplateRequest, ModifyMPSTemplateRequest, DescribeImageSpriteTemplatesRequest, DeleteImageProcessingTemplateRequest, DescribeDailyPlayStatFileListResponse, SetVodDomainCertificateRequest, DeleteSuperPlayerConfigRequest, ModifyMediaStorageClassResponse, DescribeProcedureTemplatesRequest, CreateProcedureTemplateRequest, DescribeAigcUsageDataResponse, CreatePersonSampleRequest, ReviewAudioVideoRequest, ModifySuperPlayerConfigResponse, DescribeWordSamplesResponse, RefreshUrlCacheResponse, DeleteAIRecognitionTemplateRequest, DescribeCDNStatDetailsResponse, AttachMediaSubtitlesRequest, DescribeEventConfigRequest, ModifyLLMComprehendTemplateResponse, ImportMediaKnowledgeRequest, DescribeEnhanceMediaTemplatesResponse, CreateAigcVideoTaskResponse, ModifyAdaptiveDynamicStreamingTemplateResponse, CreateRebuildMediaTemplateResponse, CreateBlindWatermarkTemplateRequest, ModifyVodDomainAccelerateConfigRequest, ModifyQualityInspectTemplateResponse, ProcessImageAsyncRequest, ModifyAdaptiveDynamicStreamingTemplateRequest, ForbidMediaDistributionRequest, DescribeAIRecognitionTemplatesResponse, EditMediaResponse, ProcessMediaByUrlRequest, DescribeDailyMostPlayedStatResponse, ModifyAIRecognitionTemplateResponse, ModifyMediaInfoRequest, ModifyPersonSampleRequest, DescribeSnapshotByTimeOffsetTemplatesRequest, ModifyHeadTailTemplateResponse, DeleteLLMComprehendTemplateResponse, CreateVodDomainRequest, DeleteRoundPlayRequest, EnhanceMediaQualityRequest, ProcessMediaResponse, CreateWordSamplesResponse, DeleteAdaptiveDynamicStreamingTemplateResponse, CreateWordSamplesRequest, DeleteVodDomainRequest, SetCLSPushTargetRequest, DescribeProcessImageAsyncTemplatesRequest, CreateAigcImageTaskResponse, ModifyAnimatedGraphicsTemplateResponse, CreateSceneAigcImageTaskResponse, DeleteCLSTopicResponse, LiveRealTimeClipRequest, DeleteAdaptiveDynamicStreamingTemplateRequest, DeleteEnhanceMediaTemplateResponse, ModifyPersonSampleResponse, CreateAigcCustomElementRequest, SimpleHlsClipResponse, DeleteAIAnalysisTemplateRequest, EditMediaRequest, CreateComplexAdaptiveDynamicStreamingTaskRequest, DescribeFileAttributesResponse, ProcessImageAsyncResponse, DescribeBlindWatermarkTemplatesRequest, DescribeJustInTimeTranscodeTemplatesResponse, CreateReviewTemplateRequest, DescribeMediaInfosResponse, DeleteProcedureTemplateResponse, DescribeReviewTemplatesResponse, DescribeAdaptiveDynamicStreamingTemplatesResponse, ForbidMediaDistributionResponse, ExtractBlindWatermarkResponse, DescribeAdaptiveDynamicStreamingTemplatesRequest, ModifyRoundPlayRequest, DeleteHeadTailTemplateResponse, RemoveWatermarkResponse, CreatePersonSampleResponse, CreateContentReviewTemplateResponse, ModifyBlindWatermarkTemplateResponse, ModifyAnimatedGraphicsTemplateRequest, DescribeAIAnalysisTemplatesRequest, DeleteWordSamplesRequest, FastEditMediaResponse, DescribeDrmDataKeyResponse, ProcessMediaRequest, DescribeMediaPlayStatDetailsResponse, ModifyContentReviewTemplateResponse, DescribeWatermarkTemplatesRequest, ModifyProcessImageAsyncTemplateResponse, CreateSuperPlayerConfigResponse, CreateEnhanceMediaTemplateResponse, DeleteReviewTemplateResponse, DescribeCDNUsageDataResponse, ModifyWordSampleRequest, CreateJustInTimeTranscodeTemplateResponse, DeleteMediaResponse, ModifySnapshotByTimeOffsetTemplateResponse, DeleteHeadTailTemplateRequest, SearchMediaResponse, ModifyAIAnalysisTemplateResponse, DescribeAigcApiTokensRequest, ModifyMediaStorageClassRequest, DescribeTranscodeTemplatesResponse, DeleteBlindWatermarkTemplateResponse, DescribeRebuildMediaTemplatesRequest, CreateCLSTopicResponse, CreateRoundPlayResponse, ProcessImageResponse, ProcessImageRequest, ModifyMediaInfoResponse, DescribeLLMComprehendTemplatesResponse, ModifyReviewTemplateRequest, CreateBlindWatermarkTemplateResponse, DescribeCLSTopicsResponse, ImportMediaKnowledgeResponse, RestoreMediaResponse, ModifyEnhanceMediaTemplateResponse, EnhanceMediaByTemplateResponse, CreateJustInTimeTranscodeTemplateRequest, CreateAigcVideoTaskRequest, ModifyBlindWatermarkTemplateRequest, DescribeHeadTailTemplatesRequest, CreateLLMComprehendTemplateResponse, DescribeCdnLogsRequest, ProcessMediaByUrlResponse, DeleteContentReviewTemplateResponse, DescribeReviewTemplatesRequest, CreateSuperPlayerConfigRequest, DeleteRebuildMediaTemplateResponse, DescribeSubAppIdsResponse, SimpleHlsClipRequest, DescribeDailyPlayStatFileListRequest, DescribeSuperPlayerConfigsResponse, DescribeDailyMostPlayedStatRequest, ModifyLLMComprehendTemplateRequest, DeleteImageSpriteTemplateResponse, DescribeContentReviewTemplatesResponse, ExtractCopyRightWatermarkRequest, DescribeEnhanceMediaTemplatesRequest, DescribeEventsStateResponse, ModifyImageSpriteTemplateResponse, SetVodDomainCertificateResponse, DeleteAigcApiTokenResponse, DescribeMPSTemplatesRequest, DescribePersonSamplesRequest, DescribeEventsStateRequest, DescribeDrmKeyProviderInfoRequest, CreateImageProcessingTemplateResponse, ModifyJustInTimeTranscodeTemplateResponse, CreateWatermarkTemplateRequest, ModifyQualityInspectTemplateRequest, DeleteImageProcessingTemplateResponse, ModifyVodDomainConfigResponse, DeleteAIAnalysisTemplateResponse, ModifyRebuildMediaTemplateResponse, CreateEnhanceMediaTemplateRequest, RebuildMediaByTemplateRequest, ModifyVodDomainConfigRequest, ConfirmEventsRequest, CreateAIRecognitionTemplateResponse, ModifySubAppIdStatusRequest, DeleteBlindWatermarkTemplateRequest, CreateSubAppIdResponse, DeleteTranscodeTemplateRequest, DescribeImageProcessingTemplatesRequest, SplitMediaRequest, ModifyEventConfigRequest, DescribeBlindWatermarkTemplatesResponse, AttachMediaSubtitlesResponse, CreateDomainVerifyRecordResponse, ExtractCopyRightWatermarkResponse, ListFilesRequest, ParseStreamingManifestRequest, DeleteSampleSnapshotTemplateResponse, DescribeStorageDetailsResponse, PullEventsResponse, CreateCLSLogsetResponse, ModifyDefaultDistributionConfigRequest, DescribeImageReviewUsageDataRequest, DescribeEventConfigResponse, DescribeCdnLogsResponse, DeletePersonSampleResponse, CreateAigcSubjectRequest, CreateSnapshotByTimeOffsetTemplateResponse, ModifyContentReviewTemplateRequest, DeleteReviewTemplateRequest, CreateLLMComprehendTemplateRequest, CreateAdaptiveDynamicStreamingTemplateResponse, DeleteSampleSnapshotTemplateRequest, DescribeStorageDataResponse, ProcessMediaByMPSRequest, ProcessMediaByMPSResponse, CreateCLSTopicRequest, ApplyUploadRequest, CreateSampleSnapshotTemplateResponse, DeleteMediaRequest, CreateQualityInspectTemplateRequest, ProcessMediaByProcedureRequest, SetCLSPushTargetResponse, DescribeCDNUsageDataRequest, DescribeLLMComprehendTemplatesRequest, CreateProcessImageAsyncTemplateResponse, DescribeReviewDetailsRequest, ModifySubAppIdInfoResponse, DeleteCLSTopicRequest, ParseStreamingManifestResponse, ListFilesResponse, CreateRoundPlayRequest, DescribeMediaPlayStatDetailsRequest, CreateClassResponse, DeleteSuperPlayerConfigResponse, DescribeSampleSnapshotTemplatesRequest, DescribeVodDomainsResponse, DescribeClientUploadAccelerationUsageDataRequest, ModifyAIRecognitionTemplateRequest, DeleteMPSTemplateResponse, DescribeStorageRegionsRequest, DescribeAigcFaceInfoResponse, CreateMPSTemplateResponse, DescribeCDNStatDetailsRequest, DeleteRoundPlayResponse, CreateStorageRegionResponse, DescribePrepaidProductsResponse, HandleCurrentPlaylistResponse, PushUrlCacheRequest, CreateAIAnalysisTemplateResponse, DeleteProcessImageAsyncTemplateRequest, ModifyClassRequest, DescribeQualityInspectTemplatesRequest, DescribeMediaInfosRequest, CreateAigcApiTokenRequest, DescribeDrmDataKeyRequest, CreateAigcCustomVoiceResponse, DescribeDrmKeyProviderInfoResponse, ExtractTraceWatermarkResponse, CreateAIRecognitionTemplateRequest, DescribeTaskDetailRequest, PullUploadRequest, ResetProcedureTemplateResponse, CreateSceneAigcVideoTaskResponse, DeleteQualityInspectTemplateResponse, CreateHeadTailTemplateResponse, DeleteWordSamplesResponse, DescribeDefaultDistributionConfigResponse, DeleteProcedureTemplateRequest, SearchMediaBySemanticsResponse, CreateMPSTemplateRequest, DeleteClassResponse, ModifyTranscodeTemplateResponse, InspectMediaQualityResponse, DeleteRebuildMediaTemplateRequest, CreateDomainVerifyRecordRequest, CreateContentReviewTemplateRequest, DescribeContentReviewTemplatesRequest, CreateComplexAdaptiveDynamicStreamingTaskResponse, DescribeImageSpriteTemplatesResponse, CreateSceneAigcImageTaskRequest, InspectMediaQualityRequest, CreateQualityInspectTemplateResponse, DescribeStorageDataRequest, DescribeTaskDetailResponse, DeleteImageSpriteTemplateRequest, ModifyDefaultDistributionConfigResponse, CreateClassRequest, ModifyRoundPlayResponse, CreateProcedureTemplateResponse, DescribeCLSLogsetsResponse, DescribeMPSTemplatesResponse, RebuildMediaResponse, SetDrmKeyProviderInfoResponse, DescribeMediaProcessUsageDataResponse, DescribeSuperPlayerConfigsRequest, DescribeCLSLogsetsRequest, DescribeAigcUsageDataRequest, CreateVodDomainResponse, ModifyVodDomainAccelerateConfigResponse, ModifyHeadTailTemplateRequest, DescribeTasksResponse, DescribeSubAppIdsRequest, ModifyMPSTemplateResponse, ReviewImageResponse, DescribeStorageRegionsResponse, ModifySnapshotByTimeOffsetTemplateRequest, ModifyReviewTemplateResponse, CreateProcessImageAsyncTemplateRequest, CreateCLSLogsetRequest, ExtractTraceWatermarkRequest, DescribeAigcApiTokensResponse, DescribeSnapshotByTimeOffsetTemplatesResponse, DeleteAigcApiTokenRequest, SetDrmKeyProviderInfoRequest, DeleteSnapshotByTimeOffsetTemplateResponse, DescribeCLSPushTargetsRequest, DescribeTasksRequest, DescribeReviewDetailsResponse, CreateTranscodeTemplateResponse, ModifySubAppIdStatusResponse, CreateAIAnalysisTemplateRequest, RebuildMediaByTemplateResponse, EnhanceMediaByTemplateRequest, DescribeAllClassResponse, ModifyImageSpriteTemplateRequest, DeleteWatermarkTemplateRequest, DeleteVodDomainResponse, DescribeWordSamplesRequest, ModifyAIAnalysisTemplateRequest, CommitUploadResponse, DescribeSampleSnapshotTemplatesResponse, ModifyProcessImageAsyncTemplateRequest, CreateAigcImageTaskRequest, ApplyUploadResponse, ReviewAudioVideoResponse, DeleteClassRequest, DescribeTranscodeTemplatesRequest, DescribeCurrentPlaylistRequest, FastEditMediaRequest, CreateRebuildMediaTemplateRequest, DescribeWatermarkTemplatesResponse, WeChatMiniProgramPublishResponse, DescribeRoundPlaysResponse, CreateAnimatedGraphicsTemplateRequest, RemoveWatermarkRequest, ExecuteFunctionRequest, ConfirmEventsResponse, CreateAigcApiTokenResponse, DescribeLicenseUsageDataRequest, DeleteTranscodeTemplateResponse, DescribePersonSamplesResponse, DescribeVodDomainsRequest, SplitMediaResponse, RestoreMediaRequest, PullEventsRequest, DescribeAIAnalysisTemplatesResponse, CreateSnapshotByTimeOffsetTemplateRequest, DescribeQualityInspectTemplatesResponse, CreateSubAppIdRequest, DescribeProcedureTemplatesResponse, SearchMediaRequest, CreateSampleSnapshotTemplateRequest, DescribeRebuildMediaTemplatesResponse, ModifyEnhanceMediaTemplateRequest, ModifyClassResponse, ProcessMediaByProcedureResponse, PullUploadResponse, DescribeProcessImageAsyncTemplatesResponse, CreateWatermarkTemplateResponse, CommitUploadRequest, DeleteAnimatedGraphicsTemplateRequest, DeleteSnapshotByTimeOffsetTemplateRequest, DescribeAnimatedGraphicsTemplatesResponse, DescribeMediaProcessUsageDataRequest, DescribeCLSPushTargetsResponse, DescribeImageProcessingTemplatesResponse, ReviewImageRequest, DescribeHeadTailTemplatesResponse, HandleCurrentPlaylistRequest, CreateAigcCustomVoiceRequest, CreateAnimatedGraphicsTemplateResponse, VerifyDomainRecordRequest, DeleteEnhanceMediaTemplateRequest, ModifyDefaultStorageRegionResponse, DescribeStorageDetailsRequest, EnhanceMediaQualityResponse, DescribeFileAttributesRequest, CreateReviewTemplateResponse, CreateSceneAigcVideoTaskRequest, DeleteWatermarkTemplateResponse, DeleteQualityInspectTemplateRequest, DeleteJustInTimeTranscodeTemplateResponse, ModifyWatermarkTemplateResponse, DescribeJustInTimeTranscodeTemplatesRequest, SearchMediaBySemanticsRequest, CreateHeadTailTemplateRequest, CreateImageSpriteTemplateResponse, DescribeAIRecognitionTemplatesRequest } from "./vod_models";
/**
 * vod client
 * @class
 */
export declare class Client extends AbstractClient {
     ...
     * 创建大模型解析模板
     */
    CreateLLMComprehendTemplate(req: CreateLLMComprehendTemplateRequest, cb?: (error: string, rep: CreateLLMComprehendTemplateResponse) => void): Promise<CreateLLMComprehendTemplateResponse>;
    /**
...
注意：模板 ID 10000 以下的为系统预置模板，不允许修改。
     */
    ModifyProcessImageAsyncTemplate(req: ModifyProcessImageAsyncTemplateRequest, cb?: (error: string, rep: ModifyProcessImageAsyncTemplateResponse) => void): Promise<ModifyProcessImageAsyncTemplateResponse>;
    /**
     * 用于异步获取文件属性。
...
如使用事件通知，事件通知的类型为 [视频编辑完成](https://cloud.tencent.com/document/product/266/33794)。
     ...
     */
    DescribeLLMComprehendTemplates(req: DescribeLLMComprehendTemplatesRequest, cb?: (error: string, rep: DescribeLLMComprehendTemplatesResponse) => void): Promise<DescribeLLMComprehendTemplatesResponse>;
    /**
     * 修改即时转码模板。
...
指定的文件必须是hls格式，所有的播单文件最好保持相同的码率和分辨率。
     ...
     */
    CreateProcessImageAsyncTemplate(req: CreateProcessImageAsyncTemplateRequest, cb?: (error: string, rep: CreateProcessImageAsyncTemplateResponse) => void): Promise<CreateProcessImageAsyncTemplateResponse>;
    /**
...
* 播放密钥，用于计算播放器签名。
     ...
     */
    DescribeProcessImageAsyncTemplates(req: DescribeProcessImageAsyncTemplatesRequest, cb?: (error: string, rep: DescribeProcessImageAsyncTemplatesResponse) => void): Promise<DescribeProcessImageAsyncTemplatesResponse>;
    /**
     ...
     * 修改大模型解析模板
     */
    ModifyLLMComprehendTemplate(req: ModifyLLMComprehendTemplateRequest, cb?: (error: string, rep: ModifyLLMComprehendTemplateResponse) => void): Promise<ModifyLLMComprehendTemplateResponse>;
    /**
     * 用于列出子应用下存储的文件条目。

**此API只在“FileID+Path模式”下可用**
     */
    ListFiles(req: ListFilesRequest, cb?: (error: string, rep: ListFilesResponse) => void): Promise<ListFilesResponse>;
    /**
     * * 该接口用于查询任务列表；
...
* 只能查询到最近三天（72 小时）内的任务。
  ...
  2. 通过 DescribeStorageRegions 接口可以查询到所有存储地域及已经开通的地域。
   ...
   3. 查询时间跨度超过1天的，返回以天为粒度的数据，否则，返回以5分钟为粒度的数据。
     */
    DescribeAigcUsageData(req: DescribeAigcUsageDataRequest, cb?: (error: string, rep: DescribeAigcUsageDataResponse) => void): Promise<DescribeAigcUsageDataResponse>;
    /**
   ...
   5. 播放统计仅针对 VOD 域名（即 EdgeOne 域名的分发不计入播放统计）。
     ...
     * 该接口用于图片处理任务
     */
    ProcessImageAsync(req: ProcessImageAsyncRequest, cb?: (error: string, rep: ProcessImageAsyncResponse) => void): Promise<ProcessImageAsyncResponse>;
    /**
...
查询模板列表时，需要将 MPS 相关参数以 JSON 格式填入 MPSDescribeTemplateParams 参数中。关于具体的任务参数配置方法，请参考 MPS 任务模板相关文档说明。
     */
    DescribeMPSTemplates(req: DescribeMPSTemplatesRequest, cb?: (error: string, rep: DescribeMPSTemplatesResponse) => void): Promise<DescribeMPSTemplatesResponse>;
    /**
...
>模板仅适用于 [音视频审核(ReviewAudioVideo)](https://cloud.tencent.com/document/api/266/80283) 和 [图片审核(ReviewImage)](https://cloud.tencent.com/document/api/266/73217) 接口。
     ...
     */
    CreateAigcSubject(req: CreateAigcSubjectRequest, cb?: (error: string, rep: CreateAigcSubjectResponse) => void): Promise<CreateAigcSubjectResponse>;
    /**
...
4. 默认刷新配额为每天100000个 URL。
   ...
   3. 查询时间跨度超过1天的，返回以天为粒度的数据，否则，返回以5分钟为粒度的数据。
     ...
     * 调用该接口，针对指定模型进行主体创建。
     */
    CreateAigcCustomElement(req: CreateAigcCustomElementRequest, cb?: (error: string, rep: CreateAigcCustomElementResponse) => void): Promise<CreateAigcCustomElementResponse>;
    /**
...
注意：模板 ID 为 10000 以下的为系统预置模板，不允许删除。
     */
    DeleteLLMComprehendTemplate(req: DeleteLLMComprehendTemplateRequest, cb?: (error: string, rep: DeleteLLMComprehendTemplateResponse) => void): Promise<DeleteLLMComprehendTemplateResponse>;
    /**
     * 该接口用于生成场景化 AIGC 图片。<b>接口处于内测阶段，如需使用请[联系我们](https://cloud.tencent.com/online-service?from=sales_sales&source=PRESALE)，接口调用会产生实际费用。</b>
     */
...
> 3. 该功能目前仍在内测中，如需测试体验，您可以联系我们获得支持。
     */
    ProcessMediaByMPS(req: ProcessMediaByMPSRequest, cb?: (error: string, rep: ProcessMediaByMPSResponse) => void): Promise<ProcessMediaByMPSResponse>;
    /**
...
> 2. 该功能目前仍在内测中，如需测试体验，您可以联系我们获得支持。
     */
    CreateMPSTemplate(req: CreateMPSTemplateRequest, cb?: (error: string, rep: CreateMPSTemplateResponse) => void): Promise<CreateMPSTemplateResponse>;
    /**
...
* 注意：禁播媒体仅能操作标准存储和低频存储的媒体。低频存储媒体，必须存储至少 30 天，提前删除或变更存储类型，仍旧按照 30 天计费；如果禁播低频存储媒体，该媒体低频存储的时长不足 30 天，会产生提前删除计费；同时，禁播后该媒体的低频存储时长会从当前时间重新开始计算，如果不满 30 天继续对该媒体进行删除或变更存储类型，也将产生提前删除计费。例：媒体 001 已经低频存储了 10 天，此时对 001 进行禁播，低频存储的计费仍旧按 30 天计算（提前删除计费时长为 30 - 10 = 20 天）；禁播后 001 的低频存储时长重新开始计算，如果禁播后第 5 天删除了 001，低频存储计费也会按 30 天计算（提前删除计费时长为 30 - 5 = 25 天）；001 实际的低频存储时长为 10 + 5 = 15 天，低频存储计费时长为 10 + 20(提前删除计费)+ 5 + 25(提前删除计费) = 60 天。
     ...
     * 用于将智能分析的结果导入到知识库中。
     */
    ImportMediaKnowledge(req: ImportMediaKnowledgeRequest, cb?: (error: string, rep: ImportMediaKnowledgeResponse) => void): Promise<ImportMediaKnowledgeResponse>;
    /**
     * 对已发起的任务进行管理。
     */
...
* 每个分类的子类数量不可超过 500 个。
     ...
     */
    DescribeAigcApiTokens(req: DescribeAigcApiTokensRequest, cb?: (error: string, rep: DescribeAigcApiTokensResponse) => void): Promise<DescribeAigcApiTokensResponse>;
    /**
...
默认接口请求频率限制：100次/秒。
     ...
     */
    DescribeAigcFaceInfo(req: DescribeAigcFaceInfoRequest, cb?: (error: string, rep: DescribeAigcFaceInfoResponse) => void): Promise<DescribeAigcFaceInfoResponse>;
    /**
     * 1. 预热指定的 URL 列表。
2. URL 的域名必须已在云点播中注册。
3. 单次请求最多指定20个 URL。
...
修改音画质重生模板。
     ...
     */
    CreateAigcAdvancedCustomElement(req: CreateAigcAdvancedCustomElementRequest, cb?: (error: string, rep: CreateAigcAdvancedCustomElementResponse) => void): Promise<CreateAigcAdvancedCustomElementResponse>;
    /**
     * * 获得用户的所有分类信息。
     */
...
注意：模板 ID 为 10000 以下的为系统预置模板，不允许删除。
     */
    DeleteProcessImageAsyncTemplate(req: DeleteProcessImageAsyncTemplateRequest, cb?: (error: string, rep: DeleteProcessImageAsyncTemplateResponse) => void): Promise<DeleteProcessImageAsyncTemplateResponse>;
    /**
     * 获取片头片尾模板列表。
     */
...
* 播放密钥，用于计算播放器签名。
     ...
     * 删除用户自定义 MPS 任务模板。
     */
    DeleteMPSTemplate(req: DeleteMPSTemplateRequest, cb?: (error: string, rep: DeleteMPSTemplateResponse) => void): Promise<DeleteMPSTemplateResponse>;
    /**
     * 获取审核模板列表。
>模板仅适用于 [音视频审核(ReviewAudioVideo)](https://cloud.tencent.com/document/api/266/80283) 和 [图片审核(ReviewImage)](https://cloud.tencent.com/document/api/266/73217) 接口。
     */
...
修改模板时，需要将 MPS 相关参数以 JSON 格式填入 MPSModifyTemplateParams 参数中。关于具体的任务参数配置方法，请参考 MPS 任务模板相关文档说明。
     */
    ModifyMPSTemplate(req: ModifyMPSTemplateRequest, cb?: (error: string, rep: ModifyMPSTemplateResponse) => void): Promise<ModifyMPSTemplateResponse>;
    /**
...
使用模板发起视频重生。
     ...
     * 使用自然语言对媒体进行语义搜索。
     */
    SearchMediaBySemantics(req: SearchMediaBySemanticsRequest, cb?: (error: string, rep: SearchMediaBySemanticsResponse) => void): Promise<SearchMediaBySemanticsResponse>;
    /**
