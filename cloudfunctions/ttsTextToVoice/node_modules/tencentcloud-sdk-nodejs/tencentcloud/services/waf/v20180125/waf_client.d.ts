...
export declare class Client extends AbstractClient {
     ...
     * [自定义规则]-批量删除接口
     */
    DeleteBatchCustomRule(req: DeleteBatchCustomRuleRequest, cb?: (error: string, rep: DeleteBatchCustomRuleResponse) => void): Promise<DeleteBatchCustomRuleResponse>;
    /**
     * 查询业务和攻击概要趋势
     */
     ...
     * 批量编辑自定义规则接口
     */
    ModifyBatchCustomRule(req: ModifyBatchCustomRuleRequest, cb?: (error: string, rep: ModifyBatchCustomRuleResponse) => void): Promise<ModifyBatchCustomRuleResponse>;
    /**
     * 查询用户所有域名的详细信息
     */
     ...
     * 解除防护对象组中的域名绑定
     */
    DeleteProtectGroupDomain(req: DeleteProtectGroupDomainRequest, cb?: (error: string, rep: DeleteProtectGroupDomainResponse) => void): Promise<DeleteProtectGroupDomainResponse>;
    /**
     * 取得信息防泄漏规则列表
     */
     ...
     * 修改批量精准白名单规则
     */
    ModifyBatchCustomWhiteRule(req: ModifyBatchCustomWhiteRuleRequest, cb?: (error: string, rep: ModifyBatchCustomWhiteRuleResponse) => void): Promise<ModifyBatchCustomWhiteRuleResponse>;
    /**
     * 描述WAF威胁情报封禁模块配置详情
     */
...
支持批量操作。
     ...
     * 增加批量精准白名单规则
     */
    AddBatchCustomWhiteRule(req: AddBatchCustomWhiteRuleRequest, cb?: (error: string, rep: AddBatchCustomWhiteRuleResponse) => void): Promise<AddBatchCustomWhiteRuleResponse>;
    /**
     ...
     * 删除批量精准白名单规则
     */
    DeleteBatchCustomWhiteRule(req: DeleteBatchCustomWhiteRuleRequest, cb?: (error: string, rep: DeleteBatchCustomWhiteRuleResponse) => void): Promise<DeleteBatchCustomWhiteRuleResponse>;
    /**
     ...
     * 批量自定义规则列表接口
     */
    DescribeBatchCustomRuleList(req: DescribeBatchCustomRuleListRequest, cb?: (error: string, rep: DescribeBatchCustomRuleListResponse) => void): Promise<DescribeBatchCustomRuleListResponse>;
    /**
     * 获取业务和攻击概览峰值
     */
     ...
     * 批量自定义规则开关接口
     */
    ModifyBatchCustomRuleStatus(req: ModifyBatchCustomRuleStatusRequest, cb?: (error: string, rep: ModifyBatchCustomRuleStatusResponse) => void): Promise<ModifyBatchCustomRuleStatusResponse>;
    /**
     * 获取防护状态以及生效的实例id
     */
     ...
     * 批量新增自定义规则接口
     */
    AddBatchCustomRule(req: AddBatchCustomRuleRequest, cb?: (error: string, rep: AddBatchCustomRuleResponse) => void): Promise<AddBatchCustomRuleResponse>;
    /**
     * 开启、关闭WAF开关
     */
     ...
     * 获取防护对象组详情
     */
    DescribeProtectGroup(req: DescribeProtectGroupRequest, cb?: (error: string, rep: DescribeProtectGroupResponse) => void): Promise<DescribeProtectGroupResponse>;
    /**
     * Saas型WAF接入查询加密套件信息
     */
     ...
     * 新建防护对象组
     */
    CreateProtectGroup(req: CreateProtectGroupRequest, cb?: (error: string, rep: CreateProtectGroupResponse) => void): Promise<CreateProtectGroupResponse>;
    /**
     * Waf ip黑白名单查询
     */
...
3. API返回数据包最大49MB，建议启用 gzip 压缩（HTTP Request Header Accept-Encoding:gzip）。
     ...
     * 获取批量精准白名单的规则列表
     */
    DescribeBatchCustomWhiteRules(req: DescribeBatchCustomWhiteRulesRequest, cb?: (error: string, rep: DescribeBatchCustomWhiteRulesResponse) => void): Promise<DescribeBatchCustomWhiteRulesResponse>;
    /**
     * 删除域名规则白名单
     */
     ...
     * 删除防护对象组
     */
    DeleteProtectGroup(req: DeleteProtectGroupRequest, cb?: (error: string, rep: DeleteProtectGroupResponse) => void): Promise<DeleteProtectGroupResponse>;
    /**
     * 增加访问控制（自定义策略）
     */
...
描述WAF自动封禁模块详情
     ...
     * 编辑防护对象组
     */
    ModifyProtectGroup(req: ModifyProtectGroupRequest, cb?: (error: string, rep: ModifyProtectGroupResponse) => void): Promise<ModifyProtectGroupResponse>;
    /**
     * clb-waf设置防护域名防护状态
     */
     ...
     * 更新批量精准白名单规则
     */
    ModifyBatchCustomWhiteRuleStatus(req: ModifyBatchCustomWhiteRuleStatusRequest, cb?: (error: string, rep: ModifyBatchCustomWhiteRuleStatusResponse) => void): Promise<ModifyBatchCustomWhiteRuleStatusResponse>;
    /**
     * 更新Tiga引擎下大类规则的防护模式
     */
