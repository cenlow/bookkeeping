...
class Client extends abstract_client_1.AbstractClient {
     ...
     * 删除一键bypass规则
     */
    async RemoveBypassAllRule(req, cb) {
...
支持批量操作。
     ...
     * 批量更改自研版限流规则开关
     */
    async EnableRateLimitsV2(req, cb) {
     ...
     * 获取api安全敏感规则列表
     */
    async DescribeApiSecSensitiveRuleList(req, cb) {
...
3. API返回数据包最大49MB，建议启用 gzip 压缩（HTTP Request Header Accept-Encoding:gzip）。
     ...
     * 更改防护等级
     */
    async ModifyProtectionLevel(req, cb) {
     ...
     */
    async QueryBypassAllStatus(req, cb) {
     ...
     * 查询限流规则列表接口
     */
    async DescribeRateLimitsV2(req, cb) {
...
描述WAF自动封禁模块详情
     ...
     * 更新自研版限流规则
     */
    async UpdateRateLimitV2(req, cb) {
     ...
     * 修改api安全敏感检测规则
     */
    async ModifyApiSecSensitiveRule(req, cb) {
