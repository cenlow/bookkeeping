...
import { DescribeCasterDisplayInfoResponse, DescribeLiveXP2PDetailInfoListResponse, DescribeOriginStreamInfoResponse, DescribeLiveWatermarkRulesResponse, StartLiveAvatarRoomRequest, ModifyPullStreamStatusRequest, DeleteLiveRecordTemplateRequest, ModifyLiveTimeShiftTemplateResponse, DescribeLiveTranscodeTemplatesRequest, DescribeBackupStreamListResponse, DescribeLiveSnapshotTemplateRequest, DescribePlayErrorCodeDetailInfoListRequest, DescribeAuditKeywordsResponse, DescribeCasterOutputInfosResponse, DescribeLiveStreamPublishedListRequest, DescribeGroupProIspPlayInfoListResponse, DescribeDeliverBandwidthListResponse, DescribeLiveTranscodeDetailInfoRequest, DescribeLiveSnapshotTemplatesRequest, CreateLiveWatermarkRuleResponse, CreateCasterPvwResponse, DescribeCasterMarkPicInfosRequest, AddLiveWatermarkRequest, DescribeLiveDomainCertRequest, DescribeLiveEnhanceInfoListRequest, StopRecordTaskRequest, ModifyLiveDomainCertBindingsRequest, StopCasterPgmResponse, CreateCasterPgmRequest, SendLiveCloudEffectRequest, DescribeCasterPlayUrlResponse, CancelCommonMixStreamResponse, DescribeLiveCertsResponse, ResumeDelayLiveStreamRequest, DescribeCallbackRecordsListRequest, DescribeTopClientIpSumInfoListResponse, DescribeLiveStreamStateResponse, DeleteLiveWatermarkRuleRequest, DescribeLiveWatermarksRequest, DescribeLiveWatermarkRulesRequest, EnableOptimalSwitchingRequest, DescribeCasterInputInfosResponse, AddCasterMarkWordInfoResponse, ModifyLiveTranscodeTemplateResponse, DescribeStreamDayPlayInfoListRequest, DeleteLiveTimeShiftRuleResponse, DescribeLivePadRulesResponse, CreatePullStreamConfigRequest, DescribeLiveCertsRequest, DescribeLiveCertResponse, DescribeVisitTopSumInfoListRequest, StopLivePadStreamResponse, DescribePushBandwidthAndFluxListResponse, DescribeLiveStreamOnlineListResponse, DescribeCasterMarkWordInfosResponse, DescribeStreamPushInfoListResponse, DescribeLiveDomainPlayInfoListRequest, DeleteLiveWatermarkRuleResponse, DeleteCasterMarkWordInfoResponse, CreateLiveAvatarRoomRequest, DescribeLogDownloadListResponse, ReleaseCasterRequest, DeleteLivePadTemplateResponse, DescribeLiveAvatarTemporaryScriptListResponse, CreateVideoRedrawTaskRequest, DeleteLiveTranscodeTemplateRequest, StopLiveAvatarRoomResponse, StopRecordTaskResponse, DescribeTranscodeTaskNumResponse, DescribeStreamPlayInfoListResponse, DescribeLivePullStreamTaskStatusResponse, ModifyLiveTranscodeTemplateRequest, DeleteLivePadRuleResponse, DescribeLiveRecordTemplateRequest, CreateLiveTranscodeTemplateRequest, DescribeLiveTimeShiftTemplatesResponse, DescribeLiveAvatarRoomsRequest, ModifyLiveStreamMonitorResponse, ForbidLiveDomainResponse, CreateRecordTaskRequest, DescribeLivePadTemplateResponse, ResumeLiveStreamRequest, DescribeBillBandwidthAndFluxListResponse, DescribeLiveDomainPlayInfoListResponse, DescribeLiveStreamMonitorListRequest, DescribeLivePullStreamTasksRequest, DeleteLiveStreamMonitorResponse, DeleteLiveCallbackTemplateRequest, ModifyCasterInputInfoRequest, DescribeCasterOutputInfosRequest, CreateLiveCallbackTemplateResponse, DescribeLiveCallbackTemplateRequest, DescribeLiveCloudEffectConfigResponse, CreateLiveStreamMonitorRequest, CreateLiveRecordRuleResponse, DescribeLiveTranscodeTemplateRequest, GenerateLiveAvatarScriptBroadcastRequest, CreateLiveWatermarkRuleRequest, DeleteRecordTaskRequest, DescribeStreamDayPlayInfoListResponse, DeleteLivePadRuleRequest, CreateLiveSnapshotRuleResponse, DescribeLiveStreamEventListResponse, DescribeLiveTranscodeTotalInfoRequest, DescribeLivePushAuthKeyRequest, DescribeCasterEmergencyStatusResponse, DescribeCasterTransitionTypesResponse, StartLiveAvatarRoomResponse, CreateCasterRequest, AddCasterOutputInfoRequest, DescribeUploadStreamNumsResponse, DescribeLiveTranscodeDetailInfoResponse, DeleteLiveTranscodeTemplateResponse, StartLiveStreamMonitorResponse, CreateScreenshotTaskResponse, DeleteLiveCallbackRuleResponse, DescribeStreamPlayInfoListRequest, DescribeCasterDisplayInfoRequest, ModifyOriginStreamInfoRequest, CreateCasterInputPushUrlResponse, DescribeLivePlayAuthKeyRequest, CreateLiveTimeShiftRuleResponse, DeleteLiveTranscodeRuleResponse, SendTemporaryScriptToAvatarRoomResponse, CreateCasterInputPushUrlRequest, DescribeLiveCloudEffectListResponse, DescribeLivePadTemplatesResponse, CreateCasterPgmFromPvwResponse, DescribeLiveTranscodeRulesRequest, DeleteLivePullStreamTaskRequest, CopyLiveAvatarRoomResponse, CreateAuditKeywordsRequest, DescribeLiveAvatarImageListResponse, DescribeAIGCTaskStatusRequest, RestartLivePullStreamTaskResponse, StopLiveRecordResponse, DeleteCasterResponse, DescribeLiveAvatarBackgroundListRequest, DeleteScreenshotTaskRequest, ModifyCasterLayoutInfoResponse, DescribeTimeShiftStreamListResponse, DescribePlayErrorCodeSumInfoListRequest, AddDelayLiveStreamRequest, DescribeLiveStreamEventListRequest, StopCasterPvwRequest, DeleteLiveRecordResponse, DescribeLivePadStreamListRequest, DescribeDeliverLogDownListResponse, DescribeBackupStreamListRequest, DescribeDeliverLogDownListRequest, DescribeLiveTimeShiftTemplatesRequest, StopLiveStreamMonitorResponse, ModifyLivePlayDomainResponse, DescribeScreenShotSheetNumListRequest, DescribeLiveDomainCertBindingsResponse, ModifyLiveAvatarScriptResponse, StopScreenshotTaskResponse, CreateLivePadTemplateResponse, DescribeLiveRecordTemplatesResponse, DescribeScreenshotTaskRequest, DescribeLivePadStreamListResponse, DeletePullStreamConfigResponse, ModifyLivePlayDomainRequest, InsertTaskTemporaryFilesResponse, DescribePlayErrorCodeDetailInfoListResponse, DescribeLiveCloudEffectConfigRequest, DescribeGroupProIspPlayInfoListRequest, CreateCasterPgmResponse, ReleaseCasterResponse, DescribeLiveTranscodeRulesResponse, DeleteAuditKeywordsRequest, CreateCasterPvwRequest, ModifyCasterLayoutInfoRequest, DeleteLiveAvatarRoomResponse, AddCasterLayoutInfoResponse, DeleteLivePullStreamTaskResponse, DescribeStreamPushInfoListRequest, ResumeLiveStreamResponse, DeletePullStreamConfigRequest, ModifyCasterResponse, DescribeLiveWatermarksResponse, CreatePullStreamConfigResponse, ModifyLivePadTemplateResponse, DescribeTopClientIpSumInfoListRequest, CreateLiveCloudEffectResponse, DescribeCallbackRecordsListResponse, DeleteLiveWatermarkRequest, UpdateLiveWatermarkRequest, CreateLiveRecordRequest, DescribeLiveStreamPushInfoListResponse, CancelCommonMixStreamRequest, DescribeLiveAvatarImageListRequest, SwitchBackupStreamRequest, DescribePullTransformPushInfoListRequest, DeleteLiveStreamMonitorRequest, DescribeLiveDelayInfoListResponse, CreateLiveSnapshotTemplateResponse, ModifyCasterMarkPicInfoRequest, DescribeProIspPlaySumInfoListRequest, UnBindLiveDomainCertResponse, CreateLiveAvatarScriptResponse, CopyLiveAvatarRoomRequest, DeleteLiveRecordRequest, StopLiveRecordRequest, DeleteLiveCallbackTemplateResponse, CreateLivePadTemplateRequest, CopyCasterRequest, CreateAuditKeywordsResponse, DescribeLivePullStreamTasksResponse, SendTemporaryScriptToAvatarRoomRequest, CreateAuditKeywordLibRequest, DescribeAreaBillBandwidthAndFluxListRequest, ModifyCasterOutputInfoResponse, ModifyLiveDomainRefererResponse, DescribeMonitorReportResponse, DescribeLiveStreamOnlineListRequest, DescribeRecordTaskRequest, ModifyLiveAvatarScriptRequest, DescribeCasterLayoutInfosResponse, ModifyLiveCallbackTemplateResponse, DescribeLiveCallbackTemplatesResponse, DescribeLivePushAuthKeyResponse, DescribeLivePullStreamTaskStatusRequest, RestartLivePullStreamTaskRequest, DescribeCasterTransitionTypesRequest, ModifyCasterMarkWordInfoResponse, EnableOptimalSwitchingResponse, DescribeLiveStreamMonitorRequest, DescribeLiveSnapshotRulesRequest, SwitchCasterToEmergencyRequest, DeleteLiveRecordRuleResponse, DeleteLiveRecordRuleRequest, StopScreenshotTaskRequest, DescribePullTransformPushInfoRequest, DescribeBillBandwidthAndFluxListRequest, AddCasterLayoutInfoRequest, GenerateLiveAvatarScriptBroadcastResponse, InsertTaskTemporaryFilesRequest, DescribeLiveCallbackTemplateResponse, CreateLivePullStreamTaskRequest, DeleteLiveSnapshotTemplateRequest, CreateScreenshotTaskRequest, DescribeAreaBillBandwidthAndFluxListResponse, DescribeCasterResponse, DescribeLiveAvatarScriptsResponse, CreateLivePullStreamTaskResponse, ModifyLivePushAuthKeyRequest, DescribeProIspPlaySumInfoListResponse, DescribeLivePlayAuthKeyResponse, DescribeLiveCallbackTemplatesRequest, CreateLivePadRuleRequest, DeleteLiveSnapshotRuleRequest, CreateLiveTimeShiftRuleRequest, StopCasterPvwResponse, DeleteLiveAvatarScriptResponse, DescribeLiveDomainRequest, DescribePushBandwidthAndFluxListRequest, CreateLiveRecordRuleRequest, ModifyLiveStreamMonitorRequest, ModifyLiveSnapshotTemplateResponse, DeleteLivePadTemplateRequest, DescribeTimeShiftStreamListRequest, DescribeLiveWatermarkRequest, DescribeLiveAvatarRoomsResponse, DescribeLiveDomainsResponse, ModifyLiveTimeShiftTemplateRequest, ModifyLiveDomainCertBindingsResponse, DescribeLiveRecordRulesRequest, DescribeCasterUserStatusRequest, DescribeLiveStreamMonitorResponse, ModifyPullStreamStatusResponse, DeleteLiveTimeShiftRuleRequest, CreateLiveCallbackTemplateRequest, CreateAuditKeywordLibResponse, DeleteRecordTaskResponse, ModifyCasterOutputInfoRequest, CreateLiveTranscodeRuleRequest, DropLiveStreamRequest, CreateCommonMixStreamRequest, DeleteCasterMarkPicInfoRequest, CreateCasterResponse, DescribeLiveSnapshotTemplateResponse, CreateLiveTimeShiftTemplateRequest, DescribeLiveDomainRefererResponse, DescribeLivePadTemplateRequest, DeleteLiveAvatarScriptRequest, DescribeHttpStatusInfoListRequest, StartLiveStreamMonitorRequest, DescribeCasterRequest, DescribeAIGCTaskStatusResponse, DeleteLiveDomainRequest, DeleteLiveTimeShiftTemplateResponse, ModifyLivePushAuthKeyResponse, DescribeScreenshotTaskResponse, ModifyPullStreamConfigRequest, DescribeProvinceIspPlayInfoListResponse, DescribeLivePackageInfoResponse, CreateLiveCallbackRuleRequest, DescribeLiveAvatarBackgroundListResponse, DescribeLiveDomainsRequest, DescribeLiveTimeShiftBillInfoListResponse, DescribeLiveCallbackRulesRequest, DescribeConcurrentRecordStreamNumRequest, DeleteCasterInputInfoRequest, DeleteScreenshotTaskResponse, DescribePullTransformPushInfoResponse, DescribeLiveCloudEffectListRequest, DescribeLiveStreamStateRequest, CreateLiveRecordTemplateResponse, AddCasterMarkWordInfoRequest, DescribeLiveAvatarTimbreListRequest, ModifyLivePlayAuthKeyResponse, DescribeLiveTimeShiftRulesResponse, DescribeLiveTranscodeTemplatesResponse, DeleteLiveCallbackRuleRequest, DescribeAllStreamPlayInfoListResponse, DescribeCasterInputInfosRequest, DescribeCasterMarkWordInfosRequest, DescribeVisitTopSumInfoListResponse, DescribeLiveRecordRulesResponse, StopLiveStreamMonitorRequest, StopLiveAvatarRoomRequest, DeleteLiveSnapshotTemplateResponse, CreateCommonMixStreamResponse, ModifyLiveDomainRefererRequest, DescribeLiveTimeShiftWriteSizeInfoListRequest, DescribeCasterUserStatusResponse, ModifyLivePullStreamTaskRequest, DescribeLogDownloadListRequest, DeleteLiveWatermarkResponse, DropLiveStreamResponse, DescribeAuditKeywordsRequest, DescribeLiveRecordTemplatesRequest, CreateLiveCallbackRuleResponse, DescribeTimeShiftRecordDetailRequest, CreateLiveTimeShiftTemplateResponse, DeleteCasterOutputInfoResponse, DescribeLivePadRulesRequest, DescribeCasterMarkPicInfosResponse, DescribePullStreamConfigsResponse, DescribeTranscodeTaskNumRequest, DescribeLiveCallbackRulesResponse, CreateRecordTaskResponse, ResumeDelayLiveStreamResponse, DescribeLiveDomainCertBindingsRequest, CreateLiveRecordTemplateRequest, CreateVideoRedrawTaskResponse, AddCasterOutputInfoResponse, DescribeHttpStatusInfoListResponse, DescribeUploadStreamNumsRequest, CreateLiveSnapshotRuleRequest, EnableLiveDomainResponse, DeleteCasterMarkPicInfoResponse, StopCasterPgmRequest, DeleteLiveAvatarRoomRequest, CreateLiveStreamMonitorResponse, DescribeCasterLayoutInfosRequest, AuthenticateDomainOwnerRequest, AddCasterMarkPicInfoResponse, CopyCasterResponse, AddCasterInputInfoRequest, ModifyLivePlayAuthKeyRequest, DescribeLiveDelayInfoListRequest, DescribeLiveTranscodeTemplateResponse, DescribeScreenShotSheetNumListResponse, ModifyLivePullStreamTaskResponse, DescribeLiveSnapshotRulesResponse, DeleteCasterRequest, DescribeLiveDomainCertResponse, AuthenticateDomainOwnerResponse, DeleteLiveTranscodeRuleRequest, AddLiveWatermarkResponse, AddCasterInputInfoResponse, ForbidLiveStreamRequest, ModifyCasterMarkWordInfoRequest, DescribeConcurrentRecordStreamNumResponse, DeleteLiveRecordTemplateResponse, DescribePullStreamConfigsRequest, ModifyOriginStreamInfoResponse, DescribePlayErrorCodeSumInfoListResponse, DescribeCasterListRequest, UnBindLiveDomainCertRequest, CreateLiveRecordResponse, UpdateLiveWatermarkResponse, ModifyLiveSnapshotTemplateRequest, DescribeLiveRecordTemplateResponse, DescribeLiveTimeShiftRulesRequest, DescribeOriginStreamInfoRequest, DescribeLiveTimeShiftBillInfoListRequest, ModifyCasterRequest, DescribeCasterEmergencyStatusRequest, DescribeLiveCertRequest, DeleteCasterLayoutInfoRequest, ModifyCasterMarkPicInfoResponse, DescribeDeliverBandwidthListRequest, DeleteAuditKeywordsResponse, DescribeLiveAvatarTemporaryScriptListRequest, DeleteCasterMarkWordInfoRequest, ModifyLiveRecordTemplateResponse, StopLivePadStreamRequest, AddLiveDomainRequest, DescribeLivePackageInfoRequest, DescribeLiveStreamMonitorListResponse, DeleteLiveTimeShiftTemplateRequest, SwitchBackupStreamResponse, AddLiveDomainResponse, ModifyPullStreamConfigResponse, CreateLiveCloudEffectRequest, DescribeProvinceIspPlayInfoListRequest, ModifyLiveAvatarRoomResponse, CreateLivePadRuleResponse, DescribeLiveWatermarkResponse, CloseSourceStreamRequest, DescribeLiveStreamPushInfoListRequest, ModifyCasterInputInfoResponse, StartLivePadStreamResponse, DeleteCasterInputInfoResponse, ForbidLiveStreamResponse, DescribeLiveSnapshotTemplatesResponse, DescribeRecordTaskResponse, CreateLiveAvatarRoomResponse, ModifyLiveAvatarRoomRequest, DescribeCasterPlayUrlRequest, DeleteLiveSnapshotRuleResponse, ForbidLiveDomainRequest, DescribeLiveAvatarScriptsRequest, DescribeLiveTimeShiftWriteSizeInfoListResponse, DescribeCasterListResponse, ModifyLiveRecordTemplateRequest, StartLivePadStreamRequest, DescribeLiveDomainRefererRequest, DescribeLiveAvatarTimbreListResponse, DescribeLiveStreamPublishedListResponse, AddDelayLiveStreamResponse, DescribeLivePadTemplatesRequest, EnableLiveDomainRequest, DescribeLiveTranscodeTotalInfoResponse, SendLiveCloudEffectResponse, DescribeLiveEnhanceInfoListResponse, CreateLiveTranscodeRuleResponse, CreateLiveTranscodeTemplateResponse, ModifyLivePadTemplateRequest, CreateLiveSnapshotTemplateRequest, ModifyLiveCallbackTemplateRequest, DeleteCasterLayoutInfoResponse, SwitchCasterToEmergencyResponse, DescribeMonitorReportRequest, DescribeAllStreamPlayInfoListRequest, DescribeLiveDomainResponse, DescribeLiveXP2PDetailInfoListRequest, DescribePullTransformPushInfoListResponse, CreateCasterPgmFromPvwRequest, CreateLiveAvatarScriptRequest, DeleteCasterOutputInfoRequest, DescribeTimeShiftRecordDetailResponse, DeleteLiveDomainResponse, AddCasterMarkPicInfoRequest, CloseSourceStreamResponse } from "./live_models";
/**
 * live client
 * @class
 */
...
查询流id的上行推流质量数据，包括音视频的帧率，码率，流逝时间，编码格式等。
     ...
     */
    DescribeLiveCloudEffectList(req: DescribeLiveCloudEffectListRequest, cb?: (error: string, rep: DescribeLiveCloudEffectListResponse) => void): Promise<DescribeLiveCloudEffectListResponse>;
    /**
...
5. 避免 创建截图任务 与 推流 操作同时进行，可能导致因截图任务未生效而引起任务延迟启动问题，两者操作间隔建议大于3秒。
     ...
     * 调用该接口，用于停止数字人直播间。
     */
    StopLiveAvatarRoom(req: StopLiveAvatarRoomRequest, cb?: (error: string, rep: StopLiveAvatarRoomResponse) => void): Promise<StopLiveAvatarRoomResponse>;
    /**
     * 该接口用来停止直播流监播任务。
     */
...
注意，修改的Index对应的水印需已存在
     ...
     * 使用该接口查询云端特效配置信息。
     */
    DescribeLiveCloudEffectConfig(req?: DescribeLiveCloudEffectConfigRequest, cb?: (error: string, rep: DescribeLiveCloudEffectConfigResponse) => void): Promise<DescribeLiveCloudEffectConfigResponse>;
    /**
     * 使用该接口发送云端特效到线上正活跃的直播流，观众可在播放端看到特效从直播流画面中展示。
     */
    SendLiveCloudEffect(req: SendLiveCloudEffectRequest, cb?: (error: string, rep: SendLiveCloudEffectResponse) => void): Promise<SendLiveCloudEffectResponse>;
    /**
     * 删除水印。
     */
...
查询天维度每条流的播放数据，包括总流量等。
     ...
     */
    DescribeLivePadStreamList(req: DescribeLivePadStreamListRequest, cb?: (error: string, rep: DescribeLivePadStreamListResponse) => void): Promise<DescribeLivePadStreamListResponse>;
    /**
     * 修改转码模板配置。
     */
...
注意：至少填写一个回调 URL。
     ...
     * 删除关键词信息。
     */
    DeleteAuditKeywords(req: DeleteAuditKeywordsRequest, cb?: (error: string, rep: DeleteAuditKeywordsResponse) => void): Promise<DeleteAuditKeywordsResponse>;
    /**
...
注：只有在主监启动前设置才生效，主监启动后设置，下次推流生效。
     ...
     * 调用该接口，用于修改数字人直播间话术。
     */
    ModifyLiveAvatarScript(req: ModifyLiveAvatarScriptRequest, cb?: (error: string, rep: ModifyLiveAvatarScriptResponse) => void): Promise<ModifyLiveAvatarScriptResponse>;
    /**
     * 修改回调模板。
     */
...
查询按省份和运营商分组的下行播放数据。
     ...
     * 查询拉流转推任务流数据统计信息。
     */
    DescribePullTransformPushInfoList(req: DescribePullTransformPushInfoListRequest, cb?: (error: string, rep: DescribePullTransformPushInfoListResponse) => void): Promise<DescribePullTransformPushInfoListResponse>;
    /**
     * 该接口用来创建新的导播台
     */
     ...
     * 查询视频转绘任务
     */
    DescribeAIGCTaskStatus(req: DescribeAIGCTaskStatusRequest, cb?: (error: string, rep: DescribeAIGCTaskStatusResponse) => void): Promise<DescribeAIGCTaskStatusResponse>;
    /**
     * 该接口用来删除一个导播台的所有信息。
...
日志数据打包存在一定延迟，24小时候数据包趋于完整。
     ...
     */
    GenerateLiveAvatarScriptBroadcast(req: GenerateLiveAvatarScriptBroadcastRequest, cb?: (error: string, rep: GenerateLiveAvatarScriptBroadcastResponse) => void): Promise<GenerateLiveAvatarScriptBroadcastResponse>;
    /**
     * 获取直播时移模板。
     */
...
注：若删除推流到腾讯云直播源站配置，即OutputIndex为0，OutputType为1的推流配置，在重新启动主监后，系统会自动重新生成一个推流到腾讯云直播源站配置。
     ...
     * 调用该接口，用于删除已有的数字人直播间。
     */
    DeleteLiveAvatarRoom(req: DeleteLiveAvatarRoomRequest, cb?: (error: string, rep: DeleteLiveAvatarRoomResponse) => void): Promise<DeleteLiveAvatarRoomResponse>;
    /**
     ...
     */
    DescribeLiveAvatarBackgroundList(req?: DescribeLiveAvatarBackgroundListRequest, cb?: (error: string, rep: DescribeLiveAvatarBackgroundListResponse) => void): Promise<DescribeLiveAvatarBackgroundListResponse>;
    /**
...
2. 不能查询被 DeleteScreenshotTask接口删除以及已过期（平台侧保留3个月）的截图任务。
     ...
     * 创建AI转绘任务
     */
    CreateVideoRedrawTask(req: CreateVideoRedrawTaskRequest, cb?: (error: string, rep: CreateVideoRedrawTaskResponse) => void): Promise<CreateVideoRedrawTaskResponse>;
    /**
     * 该接口用来将导播台切换到备播状态。
该接口使用时，主监任务需处于运行状态。
     */
    SwitchCasterToEmergency(req: SwitchCasterToEmergencyRequest, cb?: (error: string, rep: SwitchCasterToEmergencyResponse) => void): Promise<SwitchCasterToEmergencyResponse>;
    /**
     * 直播推流带宽和流量数据查询。
推流计费会先取全球推流用量和全球播放用量进行比较，满足计费条件后再按各地区用量出账。详情参见[计费文档](https://cloud.tencent.com/document/product/267/34175)。
     ...
     * 用于关闭回源客户源站功能
     */
    CloseSourceStream(req: CloseSourceStreamRequest, cb?: (error: string, rep: CloseSourceStreamResponse) => void): Promise<CloseSourceStreamResponse>;
    /**
...
3. 如果配置了域名分组，需填写准确推流域名，才可断掉当前推流。
     ...
     * 该接口用查询导播台的备播状态
     */
    DescribeCasterEmergencyStatus(req: DescribeCasterEmergencyStatusRequest, cb?: (error: string, rep: DescribeCasterEmergencyStatusResponse) => void): Promise<DescribeCasterEmergencyStatusResponse>;
    /**
     ...
     * 调用该接口，用于创建数字人直播间。
     */
    CreateLiveAvatarRoom(req: CreateLiveAvatarRoomRequest, cb?: (error: string, rep: CreateLiveAvatarRoomResponse) => void): Promise<CreateLiveAvatarRoomResponse>;
    /**
     * 该接口为监控数据接口，数据采集及统计方式与计费数据不同，仅供运营分析使用，不能用于计费对账参考。
查询实时的域名维度下行播放数据，由于数据处理有耗时，接口默认查询4分钟前的准实时数据。
     ...
     * 创建关键词，并关联到关键词库。
     */
    CreateAuditKeywords(req: CreateAuditKeywordsRequest, cb?: (error: string, rep: CreateAuditKeywordsResponse) => void): Promise<CreateAuditKeywordsResponse>;
    /**
     * 该接口为监控数据接口，数据采集及统计方式与计费数据不同，仅供运营分析使用，不能用于计费对账参考。
用于查询回调事件。
     */
     ...
     * 使用该接口将直播流停止切入垫片。
     */
    StopLivePadStream(req: StopLivePadStreamRequest, cb?: (error: string, rep: StopLivePadStreamResponse) => void): Promise<StopLivePadStreamResponse>;
    /**
...
<br>录制相关文档：[直播录制](/document/product/267/32739)。
     ...
     * 调用该接口，用于复制数字人直播间。
     */
    CopyLiveAvatarRoom(req: CopyLiveAvatarRoomRequest, cb?: (error: string, rep: CopyLiveAvatarRoomResponse) => void): Promise<CopyLiveAvatarRoomResponse>;
    /**
...
2. 点播源任务的重启，会根据VodRefreshType决定是续播还是从头开始播。
     ...
     */
    DescribeLiveAvatarTimbreList(req: DescribeLiveAvatarTimbreListRequest, cb?: (error: string, rep: DescribeLiveAvatarTimbreListResponse) => void): Promise<DescribeLiveAvatarTimbreListResponse>;
    /**
     * 修改直播推流鉴权key
     */
     ...
     */
    DescribeLiveAvatarTemporaryScriptList(req: DescribeLiveAvatarTemporaryScriptListRequest, cb?: (error: string, rep: DescribeLiveAvatarTemporaryScriptListResponse) => void): Promise<DescribeLiveAvatarTemporaryScriptListResponse>;
    /**
     * 获取水印规则列表。
     */
...
注意：单个域名仅支持关联一个截图模板。
     ...
     * 获取关键词信息。
     */
    DescribeAuditKeywords(req: DescribeAuditKeywordsRequest, cb?: (error: string, rep: DescribeAuditKeywordsResponse) => void): Promise<DescribeAuditKeywordsResponse>;
    /**
...
该接口使用时，预监任务需处于运行状态。
     ...
     * 调用该接口，查询数字人直播间信息列表。
     */
    DescribeLiveAvatarRooms(req: DescribeLiveAvatarRoomsRequest, cb?: (error: string, rep: DescribeLiveAvatarRoomsResponse) => void): Promise<DescribeLiveAvatarRoomsResponse>;
    /**
     ...
     * 调用该接口，用于临时驱动数字人播报。
     */
    SendTemporaryScriptToAvatarRoom(req: SendTemporaryScriptToAvatarRoomRequest, cb?: (error: string, rep: SendTemporaryScriptToAvatarRoomResponse) => void): Promise<SendTemporaryScriptToAvatarRoomResponse>;
    /**
...
2. 拉转推插播文件时，事件及回调中的索引均保持为插播前的值。
     */
    InsertTaskTemporaryFiles(req: InsertTaskTemporaryFilesRequest, cb?: (error: string, rep: InsertTaskTemporaryFilesResponse) => void): Promise<InsertTaskTemporaryFilesResponse>;
    /**
     * 调用该接口，用于删除已有的数字人直播间里面的话术。
     */
    DeleteLiveAvatarScript(req: DeleteLiveAvatarScriptRequest, cb?: (error: string, rep: DeleteLiveAvatarScriptResponse) => void): Promise<DeleteLiveAvatarScriptResponse>;
    /**
...
注意：云端特效生成需要一定时间，调用生成接口后，可通过查询接口，获取是否特效已生成。
     */
    CreateLiveCloudEffect(req: CreateLiveCloudEffectRequest, cb?: (error: string, rep: CreateLiveCloudEffectResponse) => void): Promise<CreateLiveCloudEffectResponse>;
    /**
     * 查询转码任务数。
     */
...
查询所有实时流的推流信息，包括客户端IP，服务端IP，帧率，码率，域名，开始推流时间。
     ...
     * 使用该接口将直播流开始切入垫片。
     */
    StartLivePadStream(req: StartLivePadStreamRequest, cb?: (error: string, rep: StartLivePadStreamResponse) => void): Promise<StartLivePadStreamResponse>;
    /**
     * 删除截图模板
     */
