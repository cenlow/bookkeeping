 ...
 * 试运行子记录
 */
export interface TestRunningSubRecord {
    /**
     * 开发时间
  注意：此字段可能返回 null，表示取不到有效值。
     */
 ...
 */
export interface CreateCodeTemplateVersionResponse {
    /**
     * 批量操作JobId
  注意：此字段可能返回 null，表示取不到有效值。
     */
 ...
 */
export interface DescribeTestRunningRecordResponse {
    /**
     * 编排空间试运行任务
  注意：此字段可能返回 null，表示取不到有效值。
     */
 ...
 */
export interface DescribeTasksForCodeTemplateResponse {
    /**
     * 无
  注意：此字段可能返回 null，表示取不到有效值。
     */
    Data?: DescribeTasksForCodeTemplatePage;
    /**
     * 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
     */
    RequestId?: string;
 ...
 */
export interface DescribeRelatedTasksByTaskIdRequest {
    /**
     * 项目Id
     */
    ProjectId: string;
 ...
 * 循环依赖响应体
 */
export interface TaskCycleLinkDTO {
    /**
     * 依赖关系唯一标识
  注意：此字段可能返回 null，表示取不到有效值。
     */
  ...
  注意：此字段可能返回 null，表示取不到有效值。
     */
    TaskFromProjectId: string;
    /**
     * 上游任务工作流ID
  注意：此字段可能返回 null，表示取不到有效值。
     */
    TaskFromWorkflowId: string;
    /**
     * 下游任务ID
  注意：此字段可能返回 null，表示取不到有效值。
     */
  ...
  注意：此字段可能返回 null，表示取不到有效值。
     */
    TaskToProjectId: string;
    /**
     * 下游任务工作流ID
  注意：此字段可能返回 null，表示取不到有效值。
     */
    TaskToWorkflowId: string;
    /**
     * 下游任务基本信息
  注意：此字段可能返回 null，表示取不到有效值。
     */
    TaskToInfo: TaskDsDTO;
    /**
     * 依赖类型
  注意：此字段可能返回 null，表示取不到有效值。
     */
 ...
 * 告警接收组
 */
export interface AlarmReceiverGroup {
    /**
     * 告警接收人类型
  注意：此字段可能返回 null，表示取不到有效值。
     */
 ...
 */
export interface DescribeRelatedTasksByTaskIdResponse {
    /**
     * 查询到的直接上下游任务列表结果
  注意：此字段可能返回 null，表示取不到有效值。
     */
    Data?: DescribeRelatedTasksByTaskIdResp;
    /**
     * 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
     */
    RequestId?: string;
 ...
 */
export interface CreateTaskNewRequest {
    /**
     * 项目Id
     */
    ProjectId: string;
 ...
 */
export interface DescribeTestRunningRecordRequest {
    /**
     * 项目ID
     */
    ProjectId: string;
 ...
 * 分页数据集
 */
export interface TaskCollectionParamDTO {
    /**
     * 总数据条数
  注意：此字段可能返回 null，表示取不到有效值。
     */
 ...
 * 查询任务绑定的事件的响应
 */
export interface DescribeRelatedTasksByTaskIdResp {
    /**
     * 页码
  注意：此字段可能返回 null，表示取不到有效值。
     */
  ...
  注意：此字段可能返回 null，表示取不到有效值。
     */
    RelatedTaskList?: Array<RelatedTask>;
}
/**
 ...
 */
export interface ReportTaskLineageRequest {
    /**
     * 上报渠道
     */
    ChannelType: string;
     ...
     * 表血缘关系
     */
    TableLineages?: Array<TableLineagePair>;
    /**
     * 列血缘关系
     */
    ColumnLineages?: Array<ColumnLineagePair>;
}
/**
 * 批量操作任务列表分页
 */
export interface DescribeTasksForCodeTemplatePage {
    /**
     * 总页码数
  注意：此字段可能返回 null，表示取不到有效值。
     */
...
export interface TaskAlarmInfo {
  ...
  注意：此字段可能返回 null，表示取不到有效值。
     */
    AlarmReceiverGroups?: Array<AlarmReceiverGroup>;
    /**
     * 告警接收组标记，0代表历史版本，1代表新版本
  注意：此字段可能返回 null，表示取不到有效值。
     */
    AlarmReceiverGroupFlag?: number;
}
/**
...
export interface TestRunningRecord {
  ...
  注意：此字段可能返回 null，表示取不到有效值。
     */
    SubRecordList?: Array<TestRunningSubRecord>;
    /**
     * 结果或日志地域
  注意：此字段可能返回 null，表示取不到有效值。
     */
 ...
 */
export interface DescribeManualTriggerRecordPageResponse {
    /**
     * 请求来源，WEB 前端；CLIENT 客户端
  注意：此字段可能返回 null，表示取不到有效值。
     */
 ...
 */
export interface DescribeTasksForCodeTemplateRequest {
    /**
     * 项目Id
     */
    ProjectId: string;
...
export interface TaskDsDTO {
  ...
  注意：此字段可能返回 null，表示取不到有效值。
     */
    CycleDependencyConfigList?: Array<TaskCycleLinkDTO>;
    /**
     * 特殊警告信息
  注意：此字段可能返回 null，表示取不到有效值。
     */
 ...
 */
export interface RegisterDsEventPublisherReq {
    /**
     * 项目id
     */
    ProjectId?: string;
 ...
 */
export interface CreateCodeTemplateVersionRequest {
    /**
     * 模版Id
     */
    CodeTemplateId: string;
 ...
 */
export interface CreateTaskNewResponse {
    /**
     * 无
  注意：此字段可能返回 null，表示取不到有效值。
     */
 ...
 */
export interface DescribeFormVersionParamResponse {
    /**
     * 结果集
  注意：此字段可能返回 null，表示取不到有效值。
     */
    Data?: TaskCollectionParamDTO;
    /**
     * 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
     */
    RequestId?: string;
 ...
 */
export interface DeleteCodeTemplateRequest {
    /**
     * 项目ID
     */
    ProjectId: string;
 ...
 * 列血缘对
 */
export interface ColumnLineagePair {
    /**
     * 列血缘来源方
     */
    Sources: Array<ColumnLineage>;
    /**
     * 列血缘目标方
     */
 ...
 */
export interface DescribeFormVersionParamRequest {
    /**
     * 项目Id
     */
    ProjectId: string;
 ...
 * 提交任务数据结构
 */
export interface CommitTaskDataDto {
    /**
     * 任务审批ID
  注意：此字段可能返回 null，表示取不到有效值。
     */
